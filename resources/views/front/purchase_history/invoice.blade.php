            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="invoice-sign">
                  ...
                  <img src="{{ asset('images/signature/'.$invoice['signature']) }}" class="img-fluid-invoice" alt="logo">
                  @else
                  <a href="{{ url('/') }}"><b>
          ...
          <div class="view-order">
            <div class="row invoice-info">
              ...
              <div class="col-sm-4 invoice-col">
                ...
                <br>
                <b>{{ __('frontstaticword.OrderID') }}:</b> {{ $orders['id'] }}<br>
                ...
                <b>
                  ...
                  {{ __('frontstaticword.EnrollEnd') }}:</b>
