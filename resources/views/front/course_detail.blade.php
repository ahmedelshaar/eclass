            ...
            <div class="col-lg-8">
                <div class="about-home-block">
                    ...
                    <ul>
                        ...
                        <li><a href="#" title="about">{{ __('frontstaticword.Created') }}: @if(isset($course->user)) <a class="font-weight-bold" href="#instructor" title="instructor"> {{ $course->user['fname'] }} {{ $course->user['lname'] }} </a> @endif</a></li>
            ...
            <div class="col-lg-4">
                                ...
                                <div class="about-home-rate">
                                    <ul>
                                        ...
                                        @if($course->discount_price == !NULL)
                                            ...
                                            <li>{{ currency($course->discount_price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = true) }}</li>
                                            <li><span><s>{{ currency($course->price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = true) }}</s></span></li>
                ...
                <div class="about-content-sidebar">
                    <div class="container">
                        ...
                        <div class="ratings">
                            ...
                            <div class="star-rating">Users Enrolled {{ $enrolled }}
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <a href="{{ route('instructor.profile', ['id' => $course->user->id, 'name' => $fullname] ) }}" class="btn btn-primary" title="course">Profile</a>
                            </div>
                ...
                <div class="about-content-sidebar mt-md-4">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <a href="{{ route('institute.view', ['id' => $insti->id,'cour' => $course->id ] ) }}" class="btn btn-primary" title="course">Profile</a>
                            </div>
            ...
            <div class="col-lg-8">
                @if($whatlearns->isNotEmpty())
                    ...
                    <div class="product-learn-block">
                        <h3 class="product-learn-heading">{{ __('frontstaticword.Whatlearn') }}</h3>
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-1 col-4">
                                <div class="course-user">
                                    <ul>
                                        ...
                                        <li>{{ $item->order->count() < 50 ? "+50" : $item->order->count() }}</li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    @if($item->discount_price == !NULL)
                                        <div class="course-currency txt-rgt">
                                            <ul>
                                                ...
                                                <li class="rate">{{ currency($item->discount_price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = true) }}</li>

                                                <li class="rate"><s>{{ currency($item->price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = true) }}</s></li>
                                    ...
                                    @else
                                        <div class="course-currency txt-rgt">
                                            <ul>
                                                ...
                                                <li>{{ currency($item->price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = true) }}</li>
                                                @endif
...
{{--                                          <a href="{{ route('instructor.profile', ['id' => $course->user->id, 'name' => $fullname] ) }}" title="instructor">--}}
...
{{--                                            <a href="{{ route('instructor.profile', ['id' => $course->user->id, 'name' => $fullname] ) }}" title="instructor-name">--}}
                                                @if(isset($course->user)) {{ $course->user['fname'] }} {{ $course->user['lname'] }} @endif
{{--                                            </a>--}}
                                        </div>
                            ...
                            <div class="together-img">
                                <div class="student-view-block">
                                    <div class="view-block">
                                        ...
                                        <div class="view-dtl">
                                            <div class="view-heading btm-10"><a href="{{ route('user.course.show',['id' => $rel->course_id, 'slug' => $rel->courses->slug ]) }}">{{ $rel->courses['title'] }}</a></div>
                                                ...
                                                @if($rel->courses->discount_price == !NULL)
                                                    <div class="rate text-right">
                                                        <ul>
                                                            ...
                                                            <li><a><b>{{ currency($rel->courses->discount_price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = true) }}</b></a></li>&nbsp;

                                                            <li><a><b><strike>{{ currency($rel->courses->price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = true) }}</strike></b></a></li>
                                                ...
                                                @else
                                                    <div class="rate text-right">
                                                        <ul>
                                                            ...
                                                            <li><a><b>{{ currency($rel->courses->price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = true) }}</b></a></li>
                ...
                @if(Auth::check())
                    <div class="report-abuse text-center btm-20">
                        <a href="#" data-toggle="modal" data-target="#myModalCourse" title="report"><i data-feather="flag"></i>{{ __('frontstaticword.Report') }}</a>
                    </div>
                @else
                    <div class="report-abuse text-center btm-20">
                        <a href="{{ route('login') }}" title="report"><i data-feather="flag"></i>{{ __('frontstaticword.Report') }}</a>
                    </div>
                @endif
