                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                @if(!empty($progress))
                                    ...
                                    <div class="about-home-btn">
                                        ...
                                        <a href="{{ route('certificate.show',['slug' => $random ]) }}" class="btn btn-secondary" href="#">Get Certificate</a>
                                    </div>
                                    @endif
                                @endif
                              </div>
...
{{--                                                  <a href="{{ route('instructor.profile', ['id' => $course->user->id, 'name' => $fullname] ) }}" title="profile">--}}
