                        ...
                        <div class="view-dtl">
                            ...
                            <div class="text-right">
                                ...
                                @if($subscrib->plans->duration == 'm')
                                    ...
                                    <li class="rate-r"><s>@if($subscrib->plans->type == 1)<i class="{{ $currency->icon }}"></i>{{ $subscrib->plans->price }} /@endif {{ $subscrib->plans->duration }} {{ __('frontstaticword.Month') }}</s></li>

                                    <li><b>@if($subscrib->plans->type == 1)<i class="{{ $currency->icon }}"></i>{{ $subscrib->plans->discount_price }}/@endif {{ $subscrib->plans->duration }} {{ __('frontstaticword.Month') }}</b></li>

                                    @else

                                    <li class="rate-r">@if($subscrib->plans->type == 1)<i class="{{ $currency->icon }}"></i>{{ $subscrib->plans->price }} /@endif {{ $subscrib->plans->duration }} {{ __('frontstaticword.Month') }}</li>
                                ...
                                @else
                                    ...
                                    @if($subscrib->plans->discount_price == !NULL)
                                    <li class="rate-r"><s>@if($subscrib->plans->type == 1)<i class="{{ $currency->icon }}"></i>{{ $subscrib->plans->price }} /@endif {{ $subscrib->plans->duration }} {{ __('frontstaticword.Days') }}</s></li>

                                    <li><b>@if($subscrib->plans->type == 1)<i class="{{ $currency->icon }}"></i>{{ $subscrib->plans->discount_price }}/@endif {{ $subscrib->plans->duration }} {{ __('frontstaticword.Days') }}</b></li>

                                    @else

                                    <li class="rate-r">@if($subscrib->plans->type == 1)<i class="{{ $currency->icon }}"></i>{{ $subscrib->plans->price }} /@endif {{ $subscrib->plans->duration }} {{ __('frontstaticword.Days') }}</li>
                            ...
                            <div class="view-dtl">
                                ...
                                <div class="text-right">
                                	...
                                	@if($plan->duration == 'm')
                                        ...
                                        <li class="rate-r"><s>@if($plan->type == 1)<i class="{{ $currency->icon }}"></i>{{ $plan->price }} /@endif {{ $plan->duration }} Month</s></li>

                                        <li><b>@if($plan->type == 1)<i class="{{ $currency->icon }}"></i>{{ $plan->discount_price }} /@endif {{ $plan->duration }} Month</b></li>

                                        @else

                                        <li class="rate-r">@if($plan->type == 1)<i class="{{ $currency->icon }}"></i>{{ $plan->price }} /@endif {{ $plan->duration }} Month</li>
                                    ...
                                    @else
                                    	...
                                    	@if($plan->discount_price == !NULL)
                                        <li class="rate-r"><s>@if($plan->type == 1)<i class="{{ $currency->icon }}"></i>{{ $plan->price }} @endif / {{ $plan->duration }} Days</s></li>

                                        <li><b>@if($plan->type == 1)<i class="{{ $currency->icon }}"></i>{{ $plan->discount_price }} / @endif {{ $plan->duration }} Days</b></li>

                                        @else

                                        <li class="rate-r">@if($plan->type == 1)<i class="{{ $currency->icon }}"></i>{{ $plan->price }} / @endif {{ $plan->duration }} Days</li>
