              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <textarea name="address" class="form-control" rows="1"
                    placeholder="{{ __('adminstaticword.Enter') }} adderss" value="">{{ $user->address }}</textarea>
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input value="{{ $user->pin_code }}"
                    placeholder="{{ __('adminstaticword.Enter') }} {{ __('adminstaticword.Pincode') }}" type="text"
