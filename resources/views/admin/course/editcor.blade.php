      ...
      <form action="{{route('course.update',$cor->id)}}" method="post" enctype="multipart/form-data">
              ...
              <br>
               ...
               <div class="row">
                <div class="col-md-6"> 
                    ...
                    <option {{ $cor->tags == 'trending' ? 'selected' : ''}} value="trending">{{ __('Trending') }}</option>

                    <option {{ $cor->tags == 'onsale' ? 'selected' : ''}} value="onsale">{{ __('Onsale') }}</option>

                    <option {{ $cor->tags == 'bestseller' ? 'selected' : ''}} value="bestseller">{{ __('Bestseller') }}</option>

                    <option {{ $cor->tags == 'beginner' ? 'selected' : ''}} value="beginner">{{ __('Beginner') }}</option>

                    <option {{ $cor->tags == 'intermediate' ? 'selected' : ''}} value="intermediate">{{ __('Intermediate') }}</option>

                    <option {{ $cor->tags == 'expert' ? 'selected' : ''}} value="expert">{{ __('Expert') }}</option>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <label>{{ __('Country :') }} <span class="redstar">*</span></label>
