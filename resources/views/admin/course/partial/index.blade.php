      ...
      @forelse($course as $cat)
        ...
        <div class="col-lg-4 mb-4">
          ...
          <div class="card">
            ...
            <div class="card-user-img">
              @if($image = @file_get_contents('../public/images/user_img/'.$cat->user->user_img))
                      ...
                      <img @error('photo') is-invalid @enderror
                          src="{{ url('images/user_img/'.$cat->user->user_img) }}" alt="profilephoto"
                          class="img-fluid" data-toggle="modal"
                          data-target="#exampleStandardModal{{ $cat->user->id }}">

              @else
              <button type="button" class="dropdown-item" data-toggle="modal"
                      data-target="#exampleStandardModal{{ $cat->user->id }}"><img @error('photo')
                          is-invalid @enderror
                          src="{{ Avatar::create($cat->user->fname)->toBase64() }}" alt="profilephoto"
                          class="img-fluid">
                  </button>
              @endif
            ...
            <div class="card-body">
              <div style="list-style-type: none;" class="mt-4"><a href="#" style="color:black">{{ __('Type') }} <span
                    class="button-align">
                    @if($cat->type == '1')
                    paid
                     @else
