        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="form-group col-md-12">
              ...
              <textarea name="detail" rows="5" class="form-control">{{ filter_var($data->detail) }}</textarea>
            </div>
            <div class="col-md-12 form-group">
                <label for="exampleInputSlug">{{ __('Skills') }}:<sup class="redstar text-danger">*</sup></label>
                <input type="text" name="skills" id="tagsinput-default" class="form-control"  value="{{ $data->skill }}" data-role="tagsinput" />
            </div>  
