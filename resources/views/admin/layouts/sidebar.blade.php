                ...
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade active show" id="v-pills-dashboard" role="tabpanel"
                        ...
                        <ul class="vertical-menu">
                            ...
                            <li
                                ...
                                <ul class="vertical-submenu">
                                    ...
                                    <li class="{{ Nav::isResource('plan/subscribe/settings') }}"><a
                                            href="{{url('plan/subscribe/settings')}}">{{ __('adminstaticword.InstructorPlan') }}
                                    ...
                                    <li class="{{ Nav::isResource('orders/subscription') }}"><a
                                            href="{{url('orders/subscription')}}">{{ __('adminstaticword.SubscribedInstructors') }}</a>
                                    </li>
                                    @endif
                            ...
                            <li
                                ...
                                <ul class="vertical-submenu">
                                    ...
                                    <li
                                        ...
                                        <a href="javaScript:void();">
                                            <i class=""></i> <span>{{ __('Zoom Live') }}</span><i
                                                class="feather icon-chevron-right"></i>
                                        </a>
                                        <ul class="vertical-submenu">
                                    ...
                                    <li
                                        ...
                                        <ul class="vertical-submenu">
                                            ...
                                            <li class="{{ Nav::isRoute('bbl.setting') }}"><a
                                                    href="{{ route('bbl.setting') }}">{{ __('BBB Settings') }}</a>
                                            </li>
                                    ...
                                    <li
                                        ...
                                        <ul class="vertical-submenu">
                                            ...
                                            <li class="{{ Nav::isRoute('googlemeet.setting') }}"><a
                                                    href="{{route('googlemeet.setting')}}">{{ __('GM Settings') }}</a>
                                            </li>
                                            <li class="{{ Nav::isRoute('googlemeet.index') }}"><a
                                                    href="{{route('googlemeet.index')}}">{{ __('GM Dashboard') }}</a>
                                            </li>
                            ...
                            <li class="{{ Nav::isRoute('themesettings.index') }}"><a
                                    href="{{route('themesettings.index')}}"><i
                                        class="feather icon-airplay text-secondary"></i><span>{{ __('adminstaticword.Themes') }}</span></a>
                            </li>
                            @endif
                            ...
                            <li class="{{ Nav::isRoute('certificate.index') }}"><a
                                    ...
                                    <i
                                        class="feather icon-help-circle text-secondary"></i><span>{{ __('CertificateVerification') }}</span>
                                </a></li>
                            <!-- contact us start -->
                            ...
                            <!-- front setting start  -->
                            <li
                                class="{{ Nav::isResource('testimonial') }} {{ Nav::isResource('advertisement') }} {{ Nav::isResource('slider') }} {{ Nav::isResource('facts') }} {{ Nav::isRoute('category.slider') }} {{ Nav::isResource('blog') }} {{ Nav::isResource('getstarted') }} {{ Nav::isResource('trusted') }} {{ Nav::isRoute('widget.setting') }} {{ Nav::isRoute('terms') }} {{ Nav::isResource('directory') }}">
                                <a href="javaScript:void();">
                                    <i
                                ...
                                <ul class="vertical-submenu">
                                    ...
                                    <li class="{{ Nav::isResource('blog') }}">
                                        <a href="{{url('blog')}}">{{ __('adminstaticword.Blog') }}</a>
                                    </li>
                                    ...
                                    <li class="{{ Nav::isResource('page') }}"><a
                                            href="{{url('page')}}"><span>{{ __('Pages') }}</span></a> </li>
                                    <!-- pages end -->
                                    ...
                                    <li class="{{ Nav::isRoute('coloroption.view') }}">
                                        <a href="{{url('admin/coloroption')}}">{{ __('Color') }}</a>
                                    </li>
                            ...
                            <!-- site setting start  -->
                            <li
                                class="{{ Nav::isRoute('gen.set') }} {{ Nav::isRoute('careers.page') }}  {{ Nav::isRoute('termscondition') }} {{ Nav::isRoute('policy') }}  {{ Nav::isRoute('show.pwa') }} {{ Nav::isRoute('adsense') }} {{ Nav::isRoute('ipblock.view') }} {{ Nav::isRoute('whatsapp.button') }}  {{ Nav::isRoute('twilio.settings') }} {{ Nav::isRoute('show.sitemap') }} {{ Nav::isRoute('get.api.key') }} {{ Nav::isRoute('show.lang') }}">
                                <a href="javaScript:void();">
                                    <i
                                ...
                                <ul class="vertical-submenu">
                                    ...
                                    <li class="{{ Nav::isRoute('whatsapp.button') }}">
                                        <a href="{{route('whatsapp.button')}}">{{ __('Whatsapp Chat') }}</a>
                                    </li>
                                    ...
                                    <li class="{{ Nav::isRoute('get.api.key') }}">
                                        <a href="{{route('get.api.key')}}">{{ __('adminstaticword.GetAPIKeys') }}</a>
                                    </li>
                            ...
                            <li class=" {{ Nav::isRoute('api.setApiView') }} ">
                                ...
                                <ul class="vertical-submenu">
                                    ...
                                    <li class="{{ Nav::isRoute('api.setApiView') }}">
                                        <a
                                            href="{{route('api.setApiView')}}{{ Nav::isRoute('bank.transfer') }}{{ Nav::isResource('manualpayment') }}">{{ __('adminstaticword.APISetting') }}</a>
                                    </li>
                            ...
                            @endif
                             ...
                             <!-- help & support start  -->
                            <li
                                class="{{ Nav::isRoute('import.view') }} {{ Nav::isRoute('database.backup') }} {{ Nav::isRoute('update.process') }} {{ Nav::isRoute('quick.update') }}">
                                <a href="javaScript:void();">
                                    <i
                                ...
                                <ul class="vertical-submenu">
                                    ...
                                    <li class="{{ Nav::isRoute('update.process') }}">
                                        <a
                                            href="{{route('update.process')}}">{{ __('adminstaticword.UpdateProcess') }}</a>
                                    </li>
                                    <li class="{{ Nav::isRoute('quick.update') }}">
                                        <a href="{{route('quick.update')}}">{{ __('adminstaticword.QuickUpdate') }}</a>
                                    </li>
                                    ...
                                    <li class="{{ Nav::isResource('admin-addon') }}">
                                        <a href="{{url('admin/addon')}}">{{ __('adminstaticword.Addon') }}
