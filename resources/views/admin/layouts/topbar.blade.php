        ...
        <div class="col-md-12 align-self-center">
            <div class="togglebar">
                <ul class="list-inline mb-0">
                    ...
                    <li class="list-inline-item">
                        <div class="menubar">
                            <a class="menu-hamburger" href="javascript:void();">
                               <img src="{{ url('admin_assets/assets/images/svg-icon/menu.svg') }}" class="img-fluid menu-hamburger-collapse" alt="menu">
                               <img src="{{ url('admin_assets/assets/images/svg-icon/close.svg') }}" class="img-fluid menu-hamburger-close" alt="close">
                             </a>
                         </div>
                    </li>
            ...
            <div class="infobar">
                ...
                <li class="list-inline-item">
                    ...
                    <li class="list-inline-item">
                        <div class="languagebar">
                        <a href="{{ url('/') }}" target="_blank"><span class="live-icon">{{ __('Visit Site') }}</span></a>   
                        </div>
                    </li>
                    <!-- = site visit end -->
