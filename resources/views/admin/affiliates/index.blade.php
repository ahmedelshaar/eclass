          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="form-group col-md-6">
                <label class="text-dark">{{ __('Refferal Code Length:') }}</label>
            
                  <input  name="ref_length" autofocus="" type="number" min="4"  class="form-control touchspin-value-attribute" placeholder="{{ __('Please enter Refferal code Length') }}" required="" value="{{ $affilates ? strip_tags($affilates->ref_length) : "" }}">
              ...
              <div class="form-group col-md-6">
                ...
                <input  name="point_per_referral" autofocus="" type="number" step="any"  class="form-control touchspin-value-attribute" placeholder="{{ __('Enter Point for per Referral') }}" value="{{ $affilates ? strip_tags($affilates->point_per_referral) : "" }}">
 
              </div>
              <div class="form-group col-md-12">
                <h4 class="box-title">{{ __('adminstaticword.FrontSetting') }}</h4>
              </div>
