...
@section('title','Create a new childcategories')
@section('breadcum')
                      ...
                      <div class="modal-dialog">
                          <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <form id="demo-form" method="post" action="{{action('ChildcategoryController@update', $cat->id)}}" data-parsley-validate class="form-horizontal form-label-left" autocomplete="off">
                                  {{ csrf_field() }}
                                  {{ method_field('PUT') }}
                                    ...
                                    <div class="col-md-12">
                                      ...
                                      <select name="subcategory_id" id="upload_id" class="form-control select2">
                                        ...
                                        @foreach($subcategory as $caat)
                                          <option {{ $cat->subcategory_id == $caat->id ? 'selected' : "" }} value="{{ $caat->id }}">{{ $caat->title }}</option>
                                        @endforeach 
                                      </select>
                                    </div>
                                  </div>
                    ...
                    <div class="modal fade bd-example-modal-sm" id="delete{{$cat->id}}" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form method="post" action="{{action('ChildcategoryController@destroy', $cat->id)}}" class="pull-right">
                                        {{csrf_field()}}
                                        {{method_field("DELETE")}}
