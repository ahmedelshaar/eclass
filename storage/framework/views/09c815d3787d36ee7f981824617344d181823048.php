...
<div class="dropdown">
    <button type="button" class="btn btn-rounded btn-success-rgba btn-sm" data-toggle="modal" data-target="#updateModal<?php echo e($id); ?>"><?php echo e(__('Update')); ?> </button>
    ...
    <!-- Model ended -->
</div><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/currency/manage/update.blade.php ENDPATH**/ ?>