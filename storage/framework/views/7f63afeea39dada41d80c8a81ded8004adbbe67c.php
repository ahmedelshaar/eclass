        ...
        <div class="col-md-8 col-lg-8">
            ...
            <div class="breadcrumb-list">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><?php echo e(__('Marketing Dashboard')); ?></li>
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-8">
                                ...
                                <p class="font-14 mb-0">Users <br> Purchase
                                </p>
                            </div>
                            <div class="col-md-4 col-4">
                            <i class="text-success iconsize feather icon-book"></i>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-8">
                                ...
                                <p class="font-14 mb-0"><?php echo e(__('Fatured')); ?>  <br> <?php echo e(__('Courses')); ?>

                                </p>
                            
                            </div>
                            <div class="col-md-4 col-4">
                            <i class="text-info iconsize feather icon-users"></i>
                            </div>
                ...
                <div class="card m-b-30 bg-secondary-rgba shadow-sm">
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4 col-4">
                            <i class="text-secondary iconsize feather icon-dollar-sign"></i>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/marketing/dashboard.blade.php ENDPATH**/ ?>