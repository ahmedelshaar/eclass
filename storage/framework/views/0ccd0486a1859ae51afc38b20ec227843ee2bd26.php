...
<?php $__env->startSection('title', 'Directory  - Admin'); ?>
...
<div class="col-md-4 col-lg-4">
  <div class="widgetbar">
      <a href="<?php echo e(url('directory/create')); ?>" class="btn btn-primary-rgba"><i class="feather icon-plus mr-2"></i><?php echo e(__("Add Directory")); ?></a>
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="box-title"><?php echo e(__('Directory')); ?></h5>
                </div>
                <div class="card-body">
                                    ...
                                    <td>
                                      <div class="dropdown">
                                          ...
                                          <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton3">
                                              <a class="dropdown-item"   href="<?php echo e(route('directory.show',$dir->id)); ?>"><i class="feather icon-edit mr-2"></i><?php echo e(__("Edit")); ?></a>
                                              ...
                                              <a class="dropdown-item"   href="<?php echo e(route('directory.view',['id' => $dir->id, 'city' => str_slug(str_replace('-','&',$dir->city))])); ?>"><i class="feather icon-eye mr-2"></i><?php echo e(__("View")); ?></a>
                                          </div>
                                      </div>
                                    </td>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/directory/index.blade.php ENDPATH**/ ?>