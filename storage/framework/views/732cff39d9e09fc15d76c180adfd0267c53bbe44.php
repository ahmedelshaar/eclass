                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                            <div class="row">
                                <div class="col-md-12 form-group">
                                    <label class="text-dark" for="s_enable"><?php echo e(__('adminstaticword.STRIPEPAYMENT')); ?></label><br>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="text-dark" for="STRIPE_KEY"><?php echo e(__('adminstaticword.StripeKey')); ?> <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="text-dark" for="s_secretkey"><?php echo e(__('adminstaticword.StripeSecretKey')); ?> <span class="text-danger">*</span></label>
                        ...
                        <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="text-dark" for="pay_enable"><?php echo e(__('adminstaticword.PAYPALPAYMENT')); ?></label><br>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="text-dark" for="pay_cid"><?php echo e(__('adminstaticword.PaypalClientID')); ?> <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="text-dark" for="pay_sid"><?php echo e(__('adminstaticword.PaypalSecretID')); ?> <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                <div class="form-group">
                                    <label class="text-dark" for="pay_mode"><?php echo e(__('adminstaticword.PaypalMode')); ?> <span class="text-danger">*</span></label>
                        ...
                        <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="text-dark" for="pay_enable"><?php echo e(__('adminstaticword.INSTAMOJOPAYMENT')); ?></label><br>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-dark" for="pay_cid"><?php echo e(__('adminstaticword.InstaMojoApiKey')); ?> <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-dark" for="pay_sid"><?php echo e(__('adminstaticword.InstaMojoAuthToken')); ?> <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-dark" for="pay_mode"><?php echo e(__('adminstaticword.InstaMojoURL')); ?> <span class="text-danger">*</span></label>
                        ...
                        <div class="tab-pane fade" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="text-dark" for="razorpay_enable"><?php echo e(__('adminstaticword.RAZORPAYPAYMENT')); ?></label><br>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-dark" for="RAZORPAY_KEY"><?php echo e(__('adminstaticword.RazorpayKey')); ?> <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-dark" for="RAZORPAY_SECRET"><?php echo e(__('adminstaticword.RazorpaySecretKey')); ?> <span class="text-danger">*</span></label>
                        ...
                        <div class="tab-pane fade" id="v-pills-PayStack" role="tabpanel" aria-labelledby="v-pills-PayStack-tab">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="text-dark" for="paystack_enable"><?php echo e(__('adminstaticword.PAYSTACKPAYMENT')); ?></label><br>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="text-dark" for="RAZORPAY_KEY"><?php echo e(__('adminstaticword.PayStackPublicKey')); ?> <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="text-dark" for="RAZORPAY_SECRET"><?php echo e(__('adminstaticword.PayStackSecretKey')); ?> <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-dark" for="RAZORPAY_KEY"><?php echo e(__('adminstaticword.PayStackPaymentUrl')); ?> <span class="text-danger">*</span></label>
                                        ...
                                        <small class="text-info"><i class="fa fa-question-circle"></i> use <b>https://api.paystack.co</b> </small>
                                    </div>
                                </div>
                                
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-dark" for="RAZORPAY_SECRET"><?php echo e(__('adminstaticword.PayStackMerchantEmail')); ?> <span class="text-danger">*</span></label>
                                        ...
                                        <small class="text-info"><i class="fa fa-question-circle"></i> use <b>Paystack email</b> </small>
                                    </div>
                                </div>

                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-dark" for="RAZORPAY_SECRET"><?php echo e(__('adminstaticword.PaystackCallbackURL')); ?> <span class="text-danger">*</span></label>
                                        <input value="<?php echo e(url('callback')); ?>" autofocus type="text" class="form-control" placeholder="" disabled/>
                                        <small class="text-info"><i class="fa fa-question-circle"></i> use <b>this callback url in Paystack account</b> </small>
                                    </div>
                                </div>
                                <div class="form-group col-md-12">
                                    <button type="reset" class="btn btn-danger-rgba mr-1"><i class="fa fa-ban"></i> <?php echo e(__("Reset")); ?></button>
                        ...
                        <div class="tab-pane fade" id="v-pills-Paytm" role="tabpanel" aria-labelledby="v-pills-Paytm-tab">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="text-dark" for="s_enable"><?php echo e(__('adminstaticword.PAYTMPAYMENT')); ?></label>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                    <label class="text-dark" for="PAYTM_ENVIRONMENT"><?php echo e(__('adminstaticword.PaytmEnviroment')); ?> <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6 form-group">
                                    <label class="text-dark" for="PAYTM_MERCHANT_ID"><?php echo e(__('adminstaticword.PaytmMerchantID')); ?> <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6 form-group">
                                    <label class="text-dark" for="PAYTM_MERCHANT_KEY"><?php echo e(__('adminstaticword.PaytmMerchantKey')); ?> <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-dark" for="PAYTM_MERCHANT_WEBSITE"><?php echo e(__('adminstaticword.PaytmMerchantWebsite')); ?> <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-dark" for="PAYTM_CHANNEL"><?php echo e(__('adminstaticword.PaytmChannel')); ?> <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-dark" for="PAYTM_INDUSTRY_TYPE"><?php echo e(__('adminstaticword.PaytmIndustryType')); ?> <span class="text-danger">*</span></label>
                        ...
                        <div class="tab-pane fade" id="v-pills-ReCaptcha" role="tabpanel" aria-labelledby="v-pills-ReCaptcha-tab">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="text-dark" for="s_enable"><?php echo e(__('adminstaticword.ReCaptcha')); ?></label><br>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                    <label class="text-dark" for="PAYTM_CHANNEL"><?php echo e(__('adminstaticword.CaptchaSiteKey')); ?> <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="text-dark" for="PAYTM_INDUSTRY_TYPE"><?php echo e(__('adminstaticword.CaptchaSecretKey')); ?> <span class="text-danger">*</span></label>
                        ...
                        <div class="tab-pane fade" id="v-pills-AWS" role="tabpanel" aria-labelledby="v-pills-AWS-tab">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="text-dark" for="aws_enable"><?php echo e(__('adminstaticword.AWSSettings')); ?></label>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-dark" for="AWS_ACCESS_KEY_ID"><?php echo e(__('adminstaticword.AWSAccessKeyID')); ?> <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-dark" for="AWS_SECRET_ACCESS_KEY"><?php echo e(__('adminstaticword.AWSSecretAccessKey')); ?> <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-dark" for="AWS_DEFAULT_REGION"><?php echo e(__('adminstaticword.AWSDefaultRegion')); ?> <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-dark" for="AWS_BUCKET"><?php echo e(__('adminstaticword.AWSBucketName')); ?> <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-dark" for="AWS_URL"><?php echo e(__('adminstaticword.AWSURL')); ?> <span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="text-info"><i class="fa fa-question-circle"></i> Choose
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="text-info"><i class="fa fa-question-circle"></i> For Test use
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="text-info"><i class="fa fa-question-circle"></i> Enter Payu
                                            Merchant key.</small>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="text-info"><i class="fa fa-question-circle"></i> Required if
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <small class="text-info"><i class="fa fa-question-circle"></i> Enter Moli
                                            Api Key</small>
                                        <br>
                                        <small class="text-info">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="text-info"><i class="fa fa-question-circle"></i> Please enter
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <small class="text-info"><i class="fa fa-question-circle"></i>Enter your
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="text-info"><i class="fa fa-question-circle"></i> Secret Key:
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="text-info"><i class="fa fa-question-circle"></i> This is the secret hash for your webhook</small>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="text-info"><i class="fa fa-question-circle"></i> Environment:
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="text-info"><i class="fa fa-question-circle"></i> Prefix: This
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="text-info"><i class="fa fa-question-circle"></i> Enter rave
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="text-info"><i class="fa fa-question-circle"></i> Logo: Enter
                        ...
                        <div class="tab-pane fade" id="v-pills-Payflexi" role="tabpanel" aria-labelledby="v-pills-Payflexi-tab">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-dark" for="PAYFLEXI_KEY"><?php echo e(__('adminstaticword.PayFlexiPublicKey')); ?> <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-dark" for="PAYFLEXI_SECRET"><?php echo e(__('adminstaticword.PayFlexiSecretKey')); ?> <span class="text-danger">*</span></label>
                                        ...
                                        <small class="text-info"><i class="fa fa-question-circle"></i> Secret Key: Your PayFlexi secretKey. Sign up on <a href="https://merchant.payflexi.co/">https://merchant.payflexi.co/</a>to get one from your settings page</small>
                                    </div>
                                </div>

                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-dark" for="PAYFLEXI_PAYMENT_GATEWAY"><?php echo e(__('adminstaticword.PayFlexiSecretKey')); ?> <span class="text-danger">*</span></label>
                                        ...
                                        <small class="text-info"><i class="fa fa-question-circle"></i> Mode:This can either be <b>'stripe'</b> or <b>'paystack'</b>. We are adding more gateways soon</small>
                                    </div>
                                </div>

                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-dark" for="PAYFLEXI_MODE"><?php echo e(__('adminstaticword.PayFlexiMode')); ?> <span class="text-danger">*</span></label>
                                        ...
                                        <small class="text-info"><i class="fa fa-question-circle"></i> Mode:This can either be <b>'test'</b> or <b>'live'</b>. Add your keys based on the mode</small>
                                    </div>
                                </div>

                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-dark" for="PAYFLEXI_WEBHOOK_URL"><?php echo e(__('adminstaticword.PayFlexiWebhookURL')); ?> <span class="text-danger">*</span></label>
                                        <input value="<?php echo e(route('payflexi.webhook')); ?>" autofocus type="text" class="form-control" placeholder="" disabled/>
                                        <small class="text-info"><i class="fa fa-question-circle"></i> use <b>this webhook url in PayFlexi Merchant settings page</b> </small>
                                    </div>
                                </div>

                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-dark" for="PAYFLEXI_WEBHOOK_URL"><?php echo e(__('adminstaticword.PayFlexiCallbackURL')); ?> <span class="text-danger">*</span></label>
                                        <input value="<?php echo e(route('payflexi.callback')); ?>" autofocus type="text" class="form-control" placeholder="" disabled/>
                                        <small class="text-info"><i class="fa fa-question-circle"></i> use <b>this callback url in PayFlexi Merchant settings page</b> </small>
                                    </div>
                                </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/setting/api.blade.php ENDPATH**/ ?>