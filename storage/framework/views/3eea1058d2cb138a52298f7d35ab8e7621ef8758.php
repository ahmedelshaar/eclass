...
<div class="col-md-4 col-lg-4">
  <div class="widgetbar">
      <a href="<?php echo e(route('institute.create')); ?>" class="btn btn-primary-rgba"><i class="feather icon-plus mr-2"></i><?php echo e(__("Add Institute")); ?></a>
    </div>
</div>
<?php $__env->endSlot(); ?>
      ...
      <div class="col-lg-12">
          <div class="card m-b-30">
              <div class="card-header">
                  <h5 class="card-title"><?php echo e(__('Institute')); ?></h5>
              </div>
              <div class="card-body">
                      ...
                      <tr>
                        ...
                        <tbody>
                          ...
                          <tr>
                              ...
                              <td><img src="<?php echo e(asset('files/institute/'.filter_var($item->image))); ?>" class="img-responsive img-circle" ></td>
                              <td><?php echo e($item->title); ?></td>
                              <td><?php echo e($item->detail); ?></td> 
                              <td><?php echo e($item->skill); ?></td>
                              <td>
                                <label class="switch">
                                  <input class="status" type="checkbox"  name="status"  data-id="<?php echo e($item->id); ?>"  <?php echo e($item->status == '1' ? 'checked' : ''); ?>> 
                                  <span class="knob"></span>
                                </label>
                              </td>
                              <td>
                                <label class="switch">
                                  <input class="verify" type="checkbox"  name="verify" data-id="<?php echo e($item->id); ?>"  <?php echo e($item->verified == '1' ? 'checked' : ''); ?>> 
                                  <span class="knob"></span>
                                </label>
                              </td>
                             ...
                             <td>
                                <div class="dropdown">
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton3">
                                      <a class="dropdown-item"   href="<?php echo e(route('institute.edit',['id' => $item->id])); ?>" ><i class="feather icon-edit mr-2"></i><?php echo e(__("Edit")); ?></a>
                    ...
                    <thead>
                      <tr>
                        ...
                        <tbody>
                          ...
                          <tr>
                              <td><?php echo e(filter_var($key+1)); ?></td>
                              <td><img src="<?php echo e(asset('files/institute/'.filter_var($value->image))); ?>" class="img-responsive img-circle" ></td>
                             ...
                             <td>
                                <div class="dropdown">
                                  <button  class="btn btn-round btn-primary-rgba" type="button" id="CustomdropdownMenuButton3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="feather icon-more-vertical-"></i></button>
                                  <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton3">
                                      <a class="dropdown-item"   href="<?php echo e(route('institute.edit',['id' => $value->id])); ?>" ><i class="feather icon-edit mr-2"></i><?php echo e(__("Edit")); ?></a>
                                      <a class="dropdown-item" data-toggle="modal" data-target=".bd-example-modal-sm"><i class="feather icon-delete mr-2"></i><?php echo e(__("Delete")); ?></a>
                                  </div>
                                </div>
                              </td>
...
<script>
  ...
  $.ajax({
      ...
      data:  {'verify': $(this).is(':checked') ? 1 : 0, 'id': $(this).data('id')},
      success: function(data){
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/Institute/index.blade.php ENDPATH**/ ?>