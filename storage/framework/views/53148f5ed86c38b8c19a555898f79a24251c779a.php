    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="alert alert-success alert-dismissible fade show">
                ...
                <form action="<?php echo e(url("/merge-quick-update")); ?>" method="POST" class="float-right d-none updaterform">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                              ...
                              <div class="col-6 text-right">
                                <a href="<?php echo e(route('user.index')); ?>"><i
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    ...
                                    <p class="font-12 mb-0"><?php echo e(__('Categories')); ?></p>
                                </div>
                                <div class="col-6 text-right">
                                    <a href="<?php echo e(route('category.index')); ?>"><i
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    ...
                                    <p class="font-14 mb-0"><?php echo e(__('Coupon')); ?></p>
                                </div>
                                <div class="col-6 text-right">
                    ...
                    <div class="card m-b-30 shadow-sm">
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col-6 text-right">
                                    <a href="<?php echo e(route('zoom.setting')); ?>"><i
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    ...
                                    <p class="font-14 mb-0"><?php echo e(__('Big Blue')); ?></p>
                                </div>
                                <?php if(Route::has('bbl.setting')): ?>
                                <div class="col-6 text-right">
                                    <a href="<?php echo e(route('bbl.setting')); ?>"><i
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    ...
                                    <p class="font-12 mb-0"><?php echo e(__('JitsiMeeting')); ?></p>
                                </div>
                                <?php if(Route::has('jitsi.dashboard')): ?>
                                <div class="col-6 text-right">
                                    <a href="<?php echo e(route('jitsi.dashboard')); ?>"><i
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    ...
                                    <p class="font-12 mb-0"><?php echo e(__('GoogleMeet')); ?></p>
                                </div>

                                <?php if(Route::has('googlemeet.index')): ?>
                                <div class="col-6 text-right">
                                    <a href="<?php echo e(route('googlemeet.index')); ?>"><i
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    ...
                                    <p class="font-14 mb-0"><?php echo e(__('Faq')); ?></p>
                                </div>
                                <div class="col-6 text-right">
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    ...
                                    <p class="font-14 mb-0"><?php echo e(__('Page')); ?></p>
                                </div>
                                <div class="col-6 text-right">
                                    <a href="<?php echo e(route('page.index')); ?>"><i
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    ...
                                    <p class="font-14 mb-0"><?php echo e(__('Testimonial')); ?></p>
                                </div>
                                <div class="col-6 text-right">
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    ...
                                    <p class="font-14 mb-0"><?php echo e(__('Instructor')); ?></p>
                                </div>
                                <div class="col-6 text-right">
                                    <a href="<?php echo e(route('instructor.index')); ?>"><i
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    ...
                                    <p class="font-14 mb-0"><?php echo e(__('Order')); ?></p>
                                </div>
                                <div class="col-6 text-right">
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    ...
                                    <p class="font-14 mb-0"><?php echo e(__('Refund Order')); ?></p>
                                </div>
                                <div class="col-6 text-right">
                                    <a href="<?php echo e(route('refundorder.index')); ?>"><i
                    ...
                    <div class="card m-b-30 shadow-sm">
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col-6 text-right">
                                    <a href="<?php echo e(route('follower.view')); ?>"><i
                                    ...
                                    <div class="card-body text-center">
                                        <span class="action-icon badge badge-primary-inverse">
                                            <?php if($topusers['user_img'] != null && $topusers['user_img'] !='' && @file_get_contents('images/user_img/'.$topusers['user_img'])): ?>
                                                ...
                                                <img src="<?php echo e(url('images/user_img/'.$topusers['user_img'])); ?>" class="dashboard-imgs" alt="">

                                            <?php else: ?>

                                            <img src="<?php echo e(Avatar::create($topusers->fname)->toBase64()); ?>" class="dashboard-imgs" alt="">
                                             <?php endif; ?>
                                    ...
                                    <div class="card-footer text-center">
                                        <div class="row">
                                            <div class="col-12 border-right">
                                                <h4><?php echo e(date('jS F Y', strtotime($topusers->created_at))); ?></h4>
                                                <p class="my-2"><?php echo e(__('Created At')); ?></p>
                                            </div>
                ...
                <div class="col-lg-12 col-xl-3 mt-md-3">
                    <div class="card m-b-30">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h5 class="card-title mb-0"><?php echo e(__('Top Instructors')); ?></h5>
                                </div>
                            ...
                            <div class="user-slider">
                                <div class="user-slider-item">
                                    <div class="card-body text-center">
                                        ...
                                        <p><span
                                                class="badge badge-primary-inverse"><?php echo e(__('Verified')); ?>:<?php echo e($topinstructors->verified); ?></span>
                                        </p>
                                    ...
                                    <div class="card-footer text-center">
                                        <div class="row">
                                            <div class="col-12 border-right">
                                                <h4><?php echo e(date('jS F Y', strtotime($topinstructors->created_at))); ?></h4>
                                                <p class="my-2"><?php echo e(__('Created At')); ?></p>
                                            </div>
                ...
                <div class="col-lg-12 col-xl-3 mt-md-3">
                    <div class="card m-b-30">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h5 class="card-title mb-0"><?php echo e(__('Top Courses')); ?></h5>
                                </div>
                                ...
                                <div class="user-slider-item">
                                    <div class="card-body text-center">
                                        <span class="action-icon badge badge-primary-inverse">
                                            ...
                                            <img src="<?php echo e(asset('images/course/'.$topcourses['preview_image'])); ?>" class="dashboard-imgs" alt="">
                                            
                                            <?php else: ?>
                                            <img src="<?php echo e(Avatar::create($topcourses->title)->toBase64()); ?>" class="dashboard-imgs" alt="">
                                            <?php endif; ?>
                                    ...
                                    <div class="card-footer text-center">
                                        <div class="row">
                                            <div class="col-12 border-right">
                                                <h4><?php echo e(optional($topcourses->user)->fname); ?></h4>
                                                <p class="my-2"><?php echo e(__('Instructor')); ?></p>
                                            </div>
                ...
                <div class="col-lg-12 col-xl-3 mt-md-3">
                    <div class="card m-b-30">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h5 class="card-title mb-0"><?php echo e(__('Top Order')); ?></h5>
                                </div>
                            ...
                            <div class="user-slider">
                                <div class="user-slider-item">
                                    <div class="card-body text-center">
                                        ...
                                        <p><span
                                                class="badge badge-primary-inverse"><?php echo e(__('Price')); ?>:<?php echo e($toporders->amount); ?></span>
                                        </p>
                                    ...
                                    <div class="card-footer text-center">
                                        <div class="row">
                                            <div class="col-12 border-right">
                                                <h4><?php echo e(date('jS F Y', strtotime($toporders->created_at))); ?></h4>
                                                <p class="my-2"><?php echo e(__('Created At')); ?></p>
                                            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card m-b-30 mt-md-2">
                        <div class="card-header">
                            <h5 class="card-title"><?php echo e(__('Monthly Registred Users in 2021')); ?></h5>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="upcomingTask">
                                            <a href="<?php echo e(url('course')); ?>"
                                                class="dropdown-item font-13"><?php echo e(__('adminstaticword.ViewAll')); ?></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p><span
                                                        class="text-dark"><?php echo e(str_limit($course['title'], $limit = 25, $end = '...')); ?></span><br>
                ...
                <div class="col-md-6 mb-4 mt-5">
                    ...
                    <div class="card m-b-30">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h5 class="card-title mb-0"><?php echo e(__('Instructor Request')); ?></h5>
                                </div>
                                <div class="col-3">
                                    <div class="dropdown">
                                        <button class="btn btn-link p-0 font-18 float-right" type="button"
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="upcomingTask">
                                            <a href="<?php echo e(route('all.instructor')); ?>"
                                                class="dropdown-item font-13"><?php echo e(__('adminstaticword.AllInstructor')); ?></a>
                                            <a href="<?php echo e(url('requestinstructor')); ?>"
                                                class="dropdown-item font-13"><?php echo e(__('adminstaticword.ViewAllInstructor')); ?></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-2 col-2">
                                    <img src="<?php echo e(asset('images/instructor/'.$instructor['image'])); ?>" alt="user "
                                        class="online img-cousre">
                                </div>
                                <div class="col-md-10 col-10">
                                    <p><span
                                            class="text-dark"><?php echo e($instructor['fname']); ?>&nbsp;<?php echo e($instructor['lname']); ?></span><br>
                                        <span> <?php echo e(str_limit($instructor['detail'], $limit = 130, $end = '...')); ?></span>
                                    </p>
                                    <div class="text-right">
                                        <h6><?php echo e(__('adminstaticword.Resume')); ?>:
                                            <a href="<?php echo e(asset('files/instructor/'.$instructor['file'])); ?>"
                                                download="<?php echo e($instructor['file']); ?>"><?php echo e(__('adminstaticword.Download')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>