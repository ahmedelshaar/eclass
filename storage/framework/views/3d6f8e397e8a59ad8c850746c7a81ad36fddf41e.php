                ...
                <tr>
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <form id="bulk_delete_form" method="post" action="<?php echo e(route('subcategories.bulk_delete')); ?>">
                              ...
                              <button type="submit" class="btn btn-danger"><?php echo e(__('Back')); ?><?php echo e(__('Yes')); ?></button>
                            </form>
                          </div>
                        </div>
                      </div>
                  ...
                  <td>
                    <form action="<?php echo e(route('subcategory.quick',$cat->id)); ?>" method="POST">
                      ...
                      <label class="switch">
                        <input class="subcategory" type="checkbox" data-id="<?php echo e($cat->id); ?>" name="status"
                      ...
                      <div class="box-body">
                        <div class="form-group">
                          <form id="demo-form2" method="post" action="<?php echo e(url('subcategory/')); ?>"
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                <label for="exampleInputTit1e"><?php echo e(__('adminstaticword.SubCategory')); ?>:<sup
                              ...
                              <div class="col-md-6">
                                <label for="exampleInputTit1e"><?php echo e(__('adminstaticword.Slug')); ?>:<sup
                                    class="redstar">*</sup></label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/category/subcategory/index.blade.php ENDPATH**/ ?>