  ...
  <div class="col-lg-12">
    <div class="card m-b-30">
      <div class="card-header">
        <h5 class="card-box"><?php echo e(__('adminstaticword.Edit')); ?> <?php echo e(__('adminstaticword.Course')); ?></h5>
      </div>
      ...
      <form action="<?php echo e(route('course.update',$cor->id)); ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-4"> 
                  ...
                  ?>
                  <label for="exampleInputSlug"><?php echo e(__('adminstaticword.SelectLanguage')); ?>: <span class="redstar">*</span></label>
               ...
               <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <input pattern="[/^\S*$/]+" type="text" class="form-control" name="slug" id="exampleInputPassword1" value="<?php echo e($cor->slug); ?>" required>
                </div>
              </div>
              <br>
              ...
              <br>
               ...
               <div class="row">
                <div class="col-md-6"> 
                    ...
                    <option <?php echo e($cor->tags == 'trending' ? 'selected' : ''); ?> value="trending"><?php echo e(__('Trending')); ?></option>

                    <option <?php echo e($cor->tags == 'onsale' ? 'selected' : ''); ?> value="onsale"><?php echo e(__('Onsale')); ?></option>

                    <option <?php echo e($cor->tags == 'bestseller' ? 'selected' : ''); ?> value="bestseller"><?php echo e(__('Bestseller')); ?></option>

                    <option <?php echo e($cor->tags == 'beginner' ? 'selected' : ''); ?> value="beginner"><?php echo e(__('Beginner')); ?></option>

                    <option <?php echo e($cor->tags == 'intermediate' ? 'selected' : ''); ?> value="intermediate"><?php echo e(__('Intermediate')); ?></option>

                    <option <?php echo e($cor->tags == 'expert' ? 'selected' : ''); ?> value="expert"><?php echo e(__('Expert')); ?></option>
                ...
                <div class="col-md-6"> 
                    <label for="exampleInputSlug"><?php echo e(__('adminstaticword.CourseTags')); ?></label>
            ...
            <!-- country end -->
              ...
              <div class="row">
                <div class="col-md-3 display-none">
                  <label for="exampleInputDetails"><?php echo e(__('adminstaticword.MoneyBack')); ?>:</label><br>
                  <label class="switch">
                    <input class="slider" type="checkbox" id="customSwitch1" name="money" <?php echo e($cor->day != '' ? 'checked' : ''); ?> />
                    <span class="knob"></span>
                  </label>
                 
                  <br>     

                  <div style="<?php echo e($cor->day == 1 ? '' : 'display:none'); ?>" id="jeet">
                    <label for="exampleInputSlug"><?php echo e(__('adminstaticword.Days')); ?>:<sup class="redstar">*</sup></label>
                    <input type="number" min="1"  class="form-control" name="day" id="exampleInputPassword1" placeholder="<?php echo e(__('adminstaticword.Enter')); ?> day" value="<?php echo e($cor->day); ?>">
                  </div>
                </div>
                <div class="col-md-3">
                  <label for="exampleInputDetails"><?php echo e(__('adminstaticword.Paid')); ?>:</label><br>  
                  <label class="switch">
                  ...
                  <div style="<?php echo e($cor->type == 1 ? '' : 'display:none'); ?>" id="doabox">
                    ...
                    <input step="0.01" type="text" inputmode="numeric" pattern="[-+]?[0-9]*[.,]?[0-9]+"  class="form-control" name="price" id="exampleInputPassword1" placeholder="<?php echo e(__('adminstaticword.Enter')); ?> <?php echo e(__('adminstaticword.Price')); ?>" value="<?php echo e($cor->price); ?>">
                 
                  <br>
                    <label for="exampleInputSlug"><?php echo e(__('adminstaticword.DiscountPrice')); ?>: <sup class="redstar">*</sup></label>
                    <input step="0.01" type="text" inputmode="numeric" pattern="[-+]?[0-9]*[.,]?[0-9]+" class="form-control" name="discount_price" id="exampleInputPassword1" placeholder="<?php echo e(__('adminstaticword.Enter')); ?> <?php echo e(__('adminstaticword.DiscountPrice')); ?>" value="<?php echo e($cor->discount_price); ?>">
                  </div>
                </div>
              
                <div class="col-md-3"> 
                  <?php if(Auth::User()->role == "admin"): ?>
                  <label for="exampleInputTit1e"><?php echo e(__('adminstaticword.Featured')); ?>:</label><br>
                  <label class="switch">
                ...
                <div class="col-md-3">
                  <?php if(Auth::User()->role == "admin"): ?>
                  <label for="exampleInputTit1e"><?php echo e(__('adminstaticword.Status')); ?>:</label><br>
                  <label class="switch">
              ...
              <br>
                ...
                <div class="col-md-4">
                  <label for="exampleInputDetails"><?php echo e(__('adminstaticword.PreviewVideo')); ?>:</label><br>
                  <label class="switch">
                  ...
                  <div <?php if($cor->preview_type =="video"): ?> class="display-none" <?php endif; ?> id="document2">
                    ...
                    <input  class="form-control" placeholder="<?php echo e(__('adminstaticword.Enter')); ?> URL" name="url" id="url" value="<?php echo e($cor->url); ?>">
                  </div>
                </div>
                
                <div class="col-md-4">
                  <label for=""><?php echo e(__('adminstaticword.Duration')); ?>: </label><br>
                  <label class="switch">
                  ...
                  <input min="1" class="form-control" name="duration" type="number" id="duration" value="<?php echo e($cor->duration); ?>" placeholder="<?php echo e(__('adminstaticword.Enter')); ?> <?php echo e(__('adminstaticword.Duration')); ?>">
                </div>
              </div>
              <br>
              ...
              <div class="row">
                ...
                <?php if(Auth::user()->role == 'instructor'): ?>
                <div class="col-md-6">
                  <label><?php echo e(__('adminstaticword.PreviewImage')); ?>:size: 270x200</label> 
                  <br> 
                  <!-- ====================== -->
                  <div class="input-group mb-3">
                      <div class="input-group-prepend">
                    ...
                    <div class="form-group">
                      <label class="control-label" for="first-name"><?php echo e(__('Image')); ?> <span
                          ...
                          <div class="input-group">
                            ...
                            <input required readonly id="image" name="preview_image" type="text"
                                class="form-control">
              ...
              <div class="col-sm-3">
                  ...
                  <label for="exampleInputDetails"><?php echo e(__('adminstaticword.Assignment')); ?>:</label><br>
                  <label class="switch">
                 ...
                 <div class="col-sm-3">
                  ...
                  <label for="exampleInputDetails"><?php echo e(__('adminstaticword.Appointment')); ?>:</label><br>
                  <label class="switch">
                 ...
                 <div class="col-sm-3">
                  ...
                  <label for="exampleInputDetails"><?php echo e(__('adminstaticword.CertificateEnable')); ?>:</label><br>  
                  <!--  -->
                  <label class="switch">
                ...
                <div class="col-sm-3">
                  ...
                  <label for=""><?php echo e(__('adminstaticword.DripContent')); ?>: </label><br>
                  <label class="switch">
            ...
            <br>
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-lg col-md-3 btn-primary-rgba"><?php echo e(__('adminstaticword.Save')); ?></button>
              </div>
...
<?php $__env->stopSection(); ?><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/course/editcor.blade.php ENDPATH**/ ?>