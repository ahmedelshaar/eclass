	...
	<div class="row">
		<div class="col-md-6">
			<div class="form-group<?php echo e($errors->has('meta_data_desc') ? ' has-error' : ''); ?>">
				<label class="text-dark" for=""><?php echo e(__('adminstaticword.MetaDataDescription')); ?> :</label>
				<textarea class="form-control" name="meta_data_desc" id="inputTextarea" rows="3" placeholder="Enter description"><?php echo e($setting->meta_data_desc); ?></textarea>
		...
		<div class="col-md-6">
			<div class="form-group<?php echo e($errors->has('meta_data_keyword') ? ' has-error' : ''); ?>">
				<label class="text-dark" for=""><?php echo e(__('adminstaticword.MetaDataKeywords')); ?> :</label>
				<textarea class="form-control" name="meta_data_keyword" id="inputTextarea" rows="3" placeholder="Use Comma to seprate keyword"><?php echo e($setting->meta_data_keyword); ?></textarea>
	...
	<div class="row">
		<div class="col-md-6">
			<div class="form-group<?php echo e($errors->has('google_ana') ? ' has-error' : ''); ?>">
				<label class="text-dark" for=""><?php echo e(__('adminstaticword.GoogleAnalyticKey')); ?> :</label>
		...
		<div class="col-md-6">
			<div class="form-group<?php echo e($errors->has('fb_pixel') ? ' has-error' : ''); ?>">
				<label class="text-dark" for=""><?php echo e(__('adminstaticword.FacebookPixelCode')); ?> :</label>
...
<?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/setting/seo.blade.php ENDPATH**/ ?>