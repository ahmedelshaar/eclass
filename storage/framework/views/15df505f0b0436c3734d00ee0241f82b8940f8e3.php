        ...
        <div class="panel panel-sum">
          <div class="modal-body">
            <form id="demo-form2" method="post" action="<?php echo e(route('coursechapter.store')); ?>" data-parsley-validate
              ...
              <div class="row">
                <div class="col-md-12">
                  <label for="exampleInputTit1e"><?php echo e(__('adminstaticword.ChapterName')); ?>: <span class="redstar">*</span>
                  </label>
                ...
                <div class="col-md-12">
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" name="file" id="file">Upload</span>
                    </div>
...
<?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/course/coursechapter/index.blade.php ENDPATH**/ ?>