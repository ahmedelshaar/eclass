...
<?php $__env->startSection('title', 'Add Advertisement - Admin'); ?>
<?php $__env->startSection('maincontent'); ?>
 

<?php $__env->startComponent('components.breadcumb',['fourthactive' => 'active']); ?>
<?php $__env->slot('heading'); ?>
   <?php echo e(__('Add Advertisement')); ?>
    ...
    <div class="col-lg-12">
      <div class="card m-b-30">
        <div class="card-header">
          <h5 class="card-title"><?php echo e(__('adminstaticword.Add')); ?> <?php echo e(__('adminstaticword.Advertisement')); ?></h5>
        </div>
        <div class="card-body">
          ...
          <form id="demo-form2" method="post" action="<?php echo e(url('advertisement/')); ?>" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="form-group col-md-6">
                <label for="exampleInputDetails"><?php echo e(__('adminstaticword.EnterURL')); ?>:<sup class="redstar">*</sup></label>
                  <input type="title" class="form-control" name="url1" id="exampleInputTitle" placeholder="<?php echo e(__('adminstaticword.EnterURL')); ?>" >

              </div>
              <div class="form-group col-md-6">
                <label for="exampleInputDetails"><?php echo e(__('adminstaticword.Position')); ?>:<sup class="redstar">*</sup></label>
              ...
              <div class="form-group col-md-6">
                <label for="exampleInputTit1e"><?php echo e(__('adminstaticword.Image')); ?>:<sup class="text-danger">*</sup></label><br>
                ...
                <small class="text-muted"><i class="fa fa-question-circle"></i> <?php echo e(__('adminstaticword.RecommnadedSize')); ?> (1375 x 409px)</small>
              </div>
              <div class="form-group col-md-6">
...
<?php echo $__env->make('admin/layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/advertisement/create.blade.php ENDPATH**/ ?>