        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="box-title"><?php echo e(__('All Order')); ?></h5>
                </div>
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="datatable" class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th><?php echo e(__('Payment')); ?> <?php echo e(__('adminstaticword.Detail')); ?></th>

                                    <th><?php echo e(__('adminstaticword.Status')); ?></th>

                                    <th><?php echo e(__('adminstaticword.SubscriptionStatus')); ?></th>
                                    <th><?php echo e(__('adminstaticword.Unenroll')); ?></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p><b><?php echo e(__('adminstaticword.User')); ?></b>:
                                        ...
                                        <p><b><?php echo e(__('adminstaticword.Course')); ?></b>:
                                    ...
                                    <td>
                                        <p><b><?php echo e(__('adminstaticword.TransactionId')); ?></b>:
                                            <?php echo e($order->transaction_id); ?></p>
                                        <p><b><?php echo e(__('adminstaticword.PaymentMethod')); ?></b>:
                                        ...
                                        <p><b><?php echo e(__('adminstaticword.TotalAmount')); ?></b>:
                                    ...
                                    <td>
                                        ...
                                        <?php else: ?>
                                        <?php echo e(__('adminstaticword.Canceled')); ?>
                                    ...
                                    <td>
                                        ...
                                        <form method="post"
                                            ...
                                            <button type="submit" class="btn btn-danger btn-xs">
                                                ...
                                                <?php echo e(__('adminstaticword.Unenroll')); ?>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                                <a class="dropdown-item" href="<?php echo e(route('view.order', $order->id)); ?>"><i
                                                        class="feather icon-eye mr-2"></i><?php echo e(__('View')); ?></a>
                                                <a class="dropdown-item btn btn-link" data-toggle="modal"
                                                    data-target="#delete<?php echo e($order->id); ?>">
...
<?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/order/index.blade.php ENDPATH**/ ?>