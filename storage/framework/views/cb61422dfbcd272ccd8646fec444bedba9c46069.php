                ...
                <tr>
                    <td class="class-type">
                        <?php if($class->type =='video' && $class->video ): ?>
                          <a href="<?php echo e(route('watchcourseclass',$class->id)); ?>" title="Course" class="<?php if($z == 0): ?>iframe <?php endif; ?>"><i class="fa fa-play-circle"></i>&nbsp;<?php echo e(__('frontstaticword.class')); ?></a>
                        <?php endif; ?>
                        ...
                        <a href="<?php echo e(route('audiocourseclass',$class->id)); ?>" title="class" class="<?php if($z == 0): ?>iframe <?php endif; ?>"><i class="fa fa-play-circle"></i>&nbsp;<?php echo e(__('frontstaticword.class')); ?></a>
                        <?php endif; ?>
                        ...
                        <a href="<?php echo e(route('downloadPdf',$class->id)); ?>" title="Course" class="iframe"><i class="fas fa-file-pdf"></i>&nbsp;<?php echo e(__('frontstaticword.View')); ?></a>
                    ...
                    <td class="class-size txt-rgt">
                        ...
                        <a href="<?php echo e(asset('files/class/material/'.$class->file)); ?>" download="<?php echo e($class->file); ?>" title="Learning Material"><i class="fa fa-download"></i></a>
                        <?php endif; ?>
                    </td>
                </tr>
            </tbody>
...
<?php endif; ?><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/include/course_class.blade.php ENDPATH**/ ?>