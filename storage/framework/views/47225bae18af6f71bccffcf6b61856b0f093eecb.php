...
<?php $__env->startSection('title', 'Career - Admin'); ?>
<?php $__env->startSection('maincontent'); ?>
<?php $__env->startComponent('components.breadcumb',['fourthactive' => 'active']); ?>
<?php $__env->slot('heading'); ?>
   <?php echo e(__('Career - Admin')); ?>
				   ...
				   <form action="<?php echo e(action('CareersController@update')); ?>" method="POST" enctype="multipart/form-data">
							...
							<div class="col-md-12">
				                ...
				                <div class="row" style="<?php echo e($careers['one_enable']==1 ? '' : 'display:none'); ?>" id="section_one">
				                	<div class="col-md-6">
					                    ...
					                    <input value="<?php echo e($careers['one_heading']); ?>" name="one_heading" type="text" class="form-control" placeholder="Enter Heading" />
					                </div>

									<div class="col-md-6">
					                    <label class="text-dark" for="one_text"><?php echo e(__('Section One Text :')); ?> <span class="text-danger">*</span></label>
					                    <textarea name="one_text" rows="1"  class="form-control" placeholder="Enter Text" ><?php echo e($careers['one_text']); ?></textarea>
					                    <br>
				                  	</div>

				                  	<div class="col-md-6">
					                    <label class="text-dark" for="one_btntxt"><?php echo e(__('Section One button Text :')); ?> <span class="text-danger">*</span></label>
					                    <input value="<?php echo e($careers['one_btntxt']); ?>" name="one_btntxt" type="text" class="form-control" placeholder="Enter Button Text" />
									</div>

									<div class="col-md-6">
					                    <label class="text-dark" for="one_btntxt"><?php echo e(__('Section One button Link :')); ?> <span class="text-danger">*</span></label>
					                    <input value="<?php echo e($careers['three_btntxt']); ?>" name="three_btntxt" type="text" class="form-control" placeholder="Enter Button Link" />
									</div>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<input type="checkbox" class="custom_toggle" id="customSwitch2" name="section_two2" <?php echo e($careers['two_enable']==1 ? 'checked' : ''); ?>/>
							...
							<div class="col-md-12">
		                        ...
		                        <div class="row" style="<?php echo e($careers['three_enable']==1 ? '' : 'display:none'); ?>" id="section_three">
									...
									<div class="col-md-6">
					                    ...
					                    <input value="<?php echo e($careers['three_heading']); ?>" name="three_heading" type="text" class="form-control" placeholder="Enter Heading"/>
					                </div>
							...
							<div class="col-md-12">
		                        ...
		                        <div class="row" style="<?php echo e($careers['five_enable']==1 ? '' : 'display:none'); ?>" id="section_five">
									<div class="col-md-4">
					                    ...
					                    <input value="<?php echo e($careers['five_heading']); ?>" name="five_heading" type="text" class="form-control" placeholder="Enter Heading" />
					                </div>

				                  	<div class="col-md-4">
					                    <label class="text-dark" for="five_text"><?php echo e(__('Section Five Text :')); ?> <span class="text-danger">*</span></label>
					                    <input value="<?php echo e($careers['five_text']); ?>" name="five_text" type="text" class="form-control" placeholder="Enter Text" />
									</div>
									...
									<div class="col-md-4 display-none">
					                    ...
					                    <input value="<?php echo e($careers['five_icon']); ?>" name="five_icon" type="text" class="form-control" placeholder="Enter Icon" />
					                    <br>
									</div>

									<div class="col-md-6">
					                    <label class="text-dark" for="five_textone"><?php echo e(__('Section Five Topic One :')); ?><span class="text-danger">*</span></label>
					                    <input value="<?php echo e($careers['five_textone']); ?>" name="five_textone" type="text" class="form-control" placeholder="Enter Topic"/>
					                    <br>
									
					                    <label class="text-dark" for="five_texttwo"><?php echo e(__('Section Five Topic Two : ')); ?><span class="text-danger">*</span></label>
					                    <input value="<?php echo e($careers['five_texttwo']); ?>" name="five_texttwo" type="text" class="form-control" placeholder="Enter Topic" />
					                    <br>
									
					                    <label class="text-dark" for="five_textthree"><?php echo e(__('Section Five Topic Three :')); ?><span class="text-danger">*</span></label>
					                    <input value="<?php echo e($careers['five_textthree']); ?>" name="five_textthree" type="text" class="form-control" placeholder="Enter Topic" />
					                    <br>
									
					                    <label class="text-dark" for="five_textfour"><?php echo e(__('Section Five Topic Four :')); ?><span class="text-danger">*</span></label>
					                    <input value="<?php echo e($careers['five_textfour']); ?>" name="five_textfour" type="text" class="form-control" placeholder="Enter Topic" />
					                    <br>
									
					                    <label class="text-dark" for="five_textfive"><?php echo e(__('Section Five Topic Five :')); ?><span class="text-danger">*</span></label>
					                    <input value="<?php echo e($careers['five_textfive']); ?>" name="five_textfive" type="text" class="form-control" placeholder="Enter Topic" />
					                    <br>
									
					                    <label class="text-dark" for="five_textsix"><?php echo e(__('Section Five Topic Six :')); ?><span class="text-danger">*</span></label>
					                    <input value="<?php echo e($careers['five_textsix']); ?>" name="five_textsix" type="text" class="form-control" placeholder="Enter Topic" />
					                    <br>
									
					                    <label class="text-dark" for="five_textseven"><?php echo e(__('Section Five Topic Seven :')); ?><span class="text-danger">*</span></label>
					                    <input value="<?php echo e($careers['five_textseven']); ?>" name="five_textseven" type="text" class="form-control" placeholder="Enter Topic" />
					                    <br>
									
					                    <label class="text-dark" for="five_texteight"><?php echo e(__('Section Five Topic Eight :')); ?><span class="text-danger">*</span></label>
					                    <input value="<?php echo e($careers['five_texteight']); ?>" name="five_texteight" type="text" class="form-control" placeholder="Enter Topic"/>
					                    <br>
									
					                    <label class="text-dark" for="five_textnine"><?php echo e(__('Section Five Topic Nine :')); ?><span class="text-danger">*</span></label>
					                    <input value="<?php echo e($careers['five_textnine']); ?>" name="five_textnine" type="text" class="form-control" placeholder="Enter Topic" />
					                    <br>
									
					                    <label class="text-dark" for="five_textten"><?php echo e(__('Section Five Topic Ten :')); ?><span class="text-danger">*</span></label>
					                    <input value="<?php echo e($careers['five_textten']); ?>" name="five_textten" type="text" class="form-control" placeholder="Enter Topic" />
					                    <br>
									</div>

									<div class="col-md-6">
					                   	<label class="text-dark" for="five_dtlone"><?php echo e(__('Section Five Detail One :')); ?><span class="text-danger">*</span></label>
					                    <textarea name="five_dtlone" rows="1"  class="form-control" placeholder="Enter Deatil" ><?php echo e($careers['five_dtlone']); ?></textarea>
					                    <br>
					                   
					                   	<label class="text-dark" for="five_dtltwo"><?php echo e(__('Section Five Detail two :')); ?><span class="text-danger">*</span></label>
					                    <textarea name="five_dtltwo" rows="1"  class="form-control" placeholder="Enter Deatil" ><?php echo e($careers['five_dtltwo']); ?></textarea>
					                    <br>
					                    
					                
					                   	<label class="text-dark" for="five_dtlthree"><?php echo e(__('Section Five Detail three :')); ?><span class="text-danger">*</span></label>
					                    <textarea name="five_dtlthree" rows="1"  class="form-control" placeholder="Enter Deatil" ><?php echo e($careers['five_dtlthree']); ?></textarea>
					                    <br>
					                    
					                   	<label class="text-dark" for="five_dtlfour"><?php echo e(__('Section Five Detail four :')); ?> <span class="text-danger">*</span></label>
					                    <textarea name="five_dtlfour" rows="1"  class="form-control" placeholder="Enter Deatil" ><?php echo e($careers['five_dtlfour']); ?></textarea>
					                    <br>
					                    
					                   	<label class="text-dark" for="five_dtlfive"><?php echo e(__('Section Five Detail five :')); ?> <span class="text-danger">*</span></label>
					                    <textarea name="five_dtlfive" rows="1"  class="form-control" placeholder="Enter Deatil" ><?php echo e($careers['five_dtlfive']); ?></textarea>
					                    <br>
					                   
					                   	<label class="text-dark" for="five_dtlsix"><?php echo e(__('Section Five Detail six :')); ?><sup class="redstar">*</sup></label>
					                    <textarea name="five_dtlsix" rows="1"  class="form-control" placeholder="Enter Deatil" ><?php echo e($careers['five_dtlsix']); ?></textarea>
					                    <br>
					                    
					                   	<label class="text-dark" for="five_dtlseven"><?php echo e(__('Section Five Detail seven :')); ?><span class="text-danger">*</span></label>
					                    <textarea name="five_dtlseven" rows="1"  class="form-control" placeholder="Enter Deatil" ><?php echo e($careers['five_dtlseven']); ?></textarea>
					                    <br>
					                    
					                   	<label class="text-dark" for="five_dtleight"><?php echo e(__('Section Five Detail eight :')); ?><span class="text-danger">*</span></label>
					                    <textarea name="five_dtleight" rows="1"  class="form-control" placeholder="Enter Deatil" ><?php echo e($careers['five_dtleight']); ?></textarea>
					                    <br>
					                    
					                   	<label class="text-dark" for="five_dtlnine"><?php echo e(__('Section Five Detail nine :')); ?> <span class="text-danger">*</span></label>
					                    <textarea name="five_dtlnine" rows="1"  class="form-control" placeholder="Enter Deatil" ><?php echo e($careers['five_dtlnine']); ?></textarea>
					                    <br>
					                    
					                   	<label class="text-dark" for="five_dtlten"><?php echo e(__('Section Five Detail ten :')); ?> <span class="text-danger">*</span></label>
					                    <textarea name="five_dtlten" rows="1"  class="form-control" placeholder="Enter Deatil" ><?php echo e($careers['five_dtlten']); ?></textarea>
					                    <br>
					                </div>
		                        </div>
				            </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/careers/edit.blade.php ENDPATH**/ ?>