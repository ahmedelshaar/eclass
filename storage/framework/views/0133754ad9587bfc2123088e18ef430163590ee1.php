        ...
        <div class="panel panel-sum">
          <div class="modal-body">
            <form id="demo-form2" method="post" action="<?php echo e(url('admin/quiztopic/')); ?>" data-parsley-validate
              ...
              <div class="row">
                <div class="col-md-12">
                  <label for="exampleInputTit1e"><?php echo e(__('adminstaticword.QuizTopic')); ?>:<span class="redstar">*</span>
                  </label>
              ...
              <div class="row">
                <div class="col-md-12">
                  <label for="exampleInputDetails"><?php echo e(__('adminstaticword.QuizDescription')); ?>:<sup
              ...
              <div class="row">
                <div class="col-md-12">
                  <label for="exampleInputTit1e"><?php echo e(__('adminstaticword.Marks')); ?>:<span class="redstar">*</span>
                  </label>
              ...
              <div class="row">
                <div class="col-md-12">
                  <label for="exampleInputTit1e"><?php echo e(__('adminstaticword.QuizTimer')); ?>:<span class="redstar">*</span>
                  </label>
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <label for="exampleInputTit1e"><?php echo e(__('adminstaticword.QuizReattempt')); ?>:</label><br>
                  <label class="switch">
...
<!-- script to change status end --><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/course/quiztopic/index.blade.php ENDPATH**/ ?>