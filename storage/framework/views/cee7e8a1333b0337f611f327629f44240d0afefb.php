...
<div class="col-md-4 col-lg-4">
  ...
  <a href="<?php echo e(url('blog/create')); ?>" class="float-right btn btn-primary-rgba mr-2"><i class="feather icon-plus mr-2"></i><?php echo e(__('Add Blog')); ?></a>
    ...
    <div class="col-lg-12">
        ...
        <div class="card m-b-30">
                ...
                <div class="card-header">
                    <h5 class="card-box"><?php echo e(__('adminstaticword.Blog')); ?></h5>
                </div> 
                        ...
                        <tbody>
                            ...
                            <?php $i++;?>
                              ...
                              <td>
                                ...
                                <img src="<?php echo e(asset('images/blog/'.$item->image)); ?>" class="img-responsive img-circle" >
                                <?php endif; ?>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                            <a class="dropdown-item" href="<?php echo e(route('blog.edit',$item->id)); ?>"><i class="feather icon-edit mr-2"></i><?php echo e(__('Edit')); ?></a>
                                            <a class="dropdown-item btn btn-link" data-toggle="modal" data-target="#delete<?php echo e($item->id); ?>" >
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/blog/index.blade.php ENDPATH**/ ?>