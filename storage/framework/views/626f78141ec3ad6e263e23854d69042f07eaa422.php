<div class="row">
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                        ...
                                        <a class="dropdown-item" href="<?php echo e(route('languages.edit', $language->id)); ?>"><i class="feather icon-edit mr-2"></i><?php echo e(__('Edit')); ?></a>
    ...
    </div><!-- row end --><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/language/index.blade.php ENDPATH**/ ?>