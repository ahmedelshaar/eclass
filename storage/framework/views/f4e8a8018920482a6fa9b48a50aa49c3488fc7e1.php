    ...
    <div class="col-lg-12">
        ...
        <div class="card m-b-30">
                ...
                <div class="card-header">
                    <h5 class="card-box"><?php echo e(__('adminstaticword.Add')); ?> <?php echo e(__('adminstaticword.ManualPaymentGateway')); ?></h5>
                </div> 
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/manual_payment/create.blade.php ENDPATH**/ ?>