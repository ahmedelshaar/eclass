...
<div class="col-md-4 col-lg-4">
  ...
  <a href="<?php echo e(url('page/create')); ?>" class="float-right btn btn-primary-rgba mr-2"><i class="feather icon-plus mr-2"></i><?php echo e(__('Add Page')); ?></a>
    ...
    <div class="col-lg-12">
        ...
        <div class="card m-b-30">
                ...
                <div class="card-header">
                    <h5 class="card-box"><?php echo e(__('All Pages')); ?></h5>
                </div> 
...
​
                        <tbody>
                            <?php $__currentLoopData = $page; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form id="bulk_delete_form" method="post"
                                                    action="<?php echo e(route('page.bulk.delete')); ?>">
                                                    <?php echo csrf_field(); ?>
                                ...
                                <td>
                                    <label class="switch">
                                        <input class="pages" type="checkbox"  data-id="<?php echo e($p->id); ?>" name="status" <?php echo e($p->status == '1' ? 'checked' : ''); ?>>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                            <a class="dropdown-item" href="<?php echo e(url('page/'.$p->id.'/edit')); ?>"><i class="feather icon-edit mr-2"></i><?php echo e(__('Edit')); ?></a>
                                    ...
                                    <div class="modal fade bd-example-modal-sm" id="delete<?php echo e($p->id); ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form method="post" action="<?php echo e(url('page/'.$p->id)); ?>" class="pull-right">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/pages/index.blade.php ENDPATH**/ ?>