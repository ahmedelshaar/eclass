  ...
  <div class="col-lg-12">
      <div class="card m-b-30">
          <div class="card-header">
              <h5 class="card-box">All Appointment</h5>

              <button type="button" class="btn btn-danger-rgba mr-2 " data-toggle="modal" data-target="#bulk_delete11"><i class="feather icon-trash mr-2"></i> Delete Selected</button>
...
<?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/course/appointment/index.blade.php ENDPATH**/ ?>