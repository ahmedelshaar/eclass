              ...
              <tr class="sortable row1" data-id="<?php echo e($cat->id); ?>">
                ...
                <td>
                  <input type="checkbox" form="bulk_delete_form" class="filled-in material-checkbox-input4" name="checked[]" value="<?php echo e($cat->id); ?>" id="checkbox<?php echo e($cat->id); ?>">
                    <label for="checkbox<?php echo e($cat->id); ?>" class="material-checkbox"></label> <?php echo $ij; ?>
            ...
            <div class="panel panel-sum">
              <div class="modal-body">
                <form enctype="multipart/form-data" id="demo-form2" method="post"
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <label for="exampleInputDetails"><?php echo e(__('adminstaticword.ChapterName')); ?>:<sup
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <label for="exampleInputDetails"><?php echo e(__('adminstaticword.Title')); ?>:<sup
                          class="redstar">*</sup></label>
                  ...
                  <div class="row">
                    <div class="col-md-12 btm-20">
                      <label for="type"><?php echo e(__('adminstaticword.Type')); ?>:<sup class="redstar">*</sup></label>
                      <select name="type" id="filetype" class="form-control select2" required>
                        ...
                        <option value="audio"><?php echo e(__('adminstaticword.Audio')); ?></option>
                    ...
                    <!--for audio -->
                    <div class="col-md-12 display-none btm-20" id="audioChoose" style="display:none">
                      <input type="radio" name="checkAudio" id="ch11" value="audiourl"> <?php echo e(__('adminstaticword.URL')); ?>

                      <input type="radio" name="checkAudio" id="ch12" value="uploadaudio">
                      <?php echo e(__('adminstaticword.UploadAudio')); ?>

                    </div>

                    <div class="col-md-12 display-none" id="audioURL" style="display:none">
                    ...
                    <div class="col-md-12 display-none" id="audioUpload" style="display:none">
                      <label for=""><?php echo e(__('adminstaticword.UploadAudio')); ?>: </label>
                      <!-- =========== -->
                    ...
                    <!--for image -->
                    <div class="col-md-12 display-none" id="imageChoose" style="display:none">
                      ...
                      <?php echo e(__('adminstaticword.UploadImage')); ?>

                    </div>

                    <div class="col-md-12 display-none" id="imageURL" style="display:none">
                      <label for=""><?php echo e(__('adminstaticword.URL')); ?>: </label>
                      <input type="text" name="imgurl" placeholder="Enter Your URL" class="form-control">
                    </div>

                    <div class="col-md-12 display-none" id="imageUpload" style="display:none">
                    ...
                    <!--video-->
                    <div class="col-md-12 display-none btm-20" id="videotype" style="display:none">
                      ...
                      <input type="radio" name="checkVideo" id="ch2"
                        value="uploadvideo">&nbsp;<?php echo e(__('adminstaticword.UploadVideo')); ?>

                      &emsp;
                      <input type="radio" name="checkVideo" id="ch9"
                        value="iframeurl">&nbsp;<?php echo e(__('adminstaticword.IframeURL')); ?>

                      &emsp;
                      <input type="radio" name="checkVideo" id="ch10"
                        value="liveurl">&nbsp;<?php echo e(__('adminstaticword.LiveClass')); ?>

                      &emsp;

                      <?php if($gsetting->aws_enable == 1): ?>
                      <input type="radio" name="checkVideo" id="ch13"
                        value="aws_upload">&nbsp;<?php echo e(__('adminstaticword.AWSUpload')); ?>
                    ...
                    <div class="col-md-12 display-none" id="videoURL" style="display:none">
                      <label for=""><?php echo e(__('adminstaticword.URL')); ?>: </label>
                      <input type="text" id="apiUrl" name="vidurl" placeholder="Enter Your URL" class="form-control">
                    </div>

                    <div class="col-md-12 display-none" id="videoUpload" style="display:none">
                    ...
                    <div class="col-md-12 display-none" id="iframeURLBox" style="display:none">
                    ...
                    <div class="col-md-12 display-none" id="liveclassBox" style="display:none">
                    ...
                    <!-- aws insert -->
                    <?php if($gsetting->aws_enable == 1): ?>
                    <div class="col-md-12 display-none" id="awsBox" style="display:none">
                      <label for="appt"><?php echo e(__('adminstaticword.AWSUpload')); ?></label>
                      <!-- =========== -->
                      <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroupFileAddon01">Upload</span>
                    ...
                    <!-- zip -->
                    <div class="col-md-12 display-none btm-20" id="zipChoose" style="display:none">
                      ...
                      <?php echo e(__('adminstaticword.UploadZip')); ?>

                    </div>

                    <div class="col-md-12 display-none" id="zipURL" style="display:none">
                      <label for=""><?php echo e(__('adminstaticword.URL')); ?>: </label>
                      <input type="text" name="zipurl" placeholder="Enter Your URL" class="form-control">
                    </div>

                    <div class="col-md-12 display-none" id="zipUpload" style="display:none">
                    ...
                    <!-- pdf -->
                    <div class="col-md-12 display-none btm-20" id="pdfChoose" style="display:none">
                      <input type="radio" value="pdfURLEnable" name="checkPdf" id="ch7"> <?php echo e(__('adminstaticword.URL')); ?>

                      <input type="radio" value="pdfEnable" name="checkPdf" id="ch8">
                      <?php echo e(__('adminstaticword.UploadPdf')); ?>

                    </div>

                    <div class="col-md-12 display-none" id="pdfURL" style="display:none">
                      <label for=""> <?php echo e(__('adminstaticword.URL')); ?>: </label>
                      <input type="text" name="pdfurl" placeholder="Enter Your URL" class="form-control">
                    </div>

                    <div class="col-md-12 display-none" id="pdfUpload" style="display:none">
                    ...
                    <div class="col-md-12 display-none" id="duration_video" style="display:none">
                    ...
                    <div class="col-md-12 display-none" id="size" style="display:none">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <label for="exampleInputDetails"><?php echo e(__('adminstaticword.LearningMaterial')); ?></label> - <p
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <label for="exampleInputDetails"><?php echo e(__('adminstaticword.Featured')); ?>:</label><br>
                      <label class="switch">
...
<?php $__env->stopSection(); ?><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/course/courseclass/index.blade.php ENDPATH**/ ?>