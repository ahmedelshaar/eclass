...
<?php $__env->startSection('title', 'Addon Manager - Admin'); ?>
<?php $__env->startSection('maincontent'); ?>
<?php $__env->startComponent('components.breadcumb',['fourthactive' => 'active']); ?>
<?php $__env->slot('heading'); ?>
   <?php echo e(__('Addon Manager')); ?>
    ...
    <div class="col-lg-12">
        ...
        <div class="card m-b-30">
                ...
                <div class="card-header">
                    <h5 class="card-box"><?php echo e(__('adminstaticword.Addon')); ?> <?php echo e(__('adminstaticword.Manager')); ?></h5>
                </div> 
                ...
                <div class="table-responsive">
                        ...
                        <?php $i=0;?>
                          <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <button type="button" class="btn btn-rounded <?php echo e($module->isStatus(1) ? 'btn-success-rgba' : 'btn-danger-rgba'); ?>" data-toggle="modal" data-target="#myModal">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                            <a class="dropdown-item btn btn-link" data-toggle="modal" data-target="#delete<?php echo e($module); ?>" >
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/addon/index.blade.php ENDPATH**/ ?>