	...
	<head>
		...
		<style>
			.UVPSubtitle
			{
				...
				color:<?php echo e(optional($psetting)->subtitle_color); ?>!important;
				text-shadow: 0px 0px 1px #000000 !important;
				font-size:<?php echo e(optional($psetting)->subtitle_font_size); ?>px!important;
				line-height:<?php echo e(optional($psetting)->subtitle_font_size); ?>px!important;
			...
			<?php if(Auth::user()->role == "user" && $courses->drip_enable == 1 && $chapter->drip_type != NULL): ?>
				...
				<?php if($chapter->drip_type == 'date' && $chapter->drip_date != NULL): ?>
					...
					<li data-source="courseplaycontent<?php echo e($chapter->id); ?>" data-playlist-name="<?php echo e($chapter->chapter_name); ?>" data-thumbnail-path="<?php echo e(url('images/course/'.$courses->preview_image)); ?>">
						...
						<p class="minimalDarkCategoriesDescription"><span class="minimialDarkBold">Description: </span><?php echo e($courses->short_detail); ?></p>
					</li>
					<?php endif; ?>
						...
						<?php endif; ?>
							...
							?>
							    ...
							    <div data-video-short-description="">
				        			 ...
				        			 <p class="minimalDarkCategoriesDescription"><span class="minimialDarkBold">Description: </span><?php echo e($chapter->courses->short_detail); ?></p>
							    </div>
...
<?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/watch.blade.php ENDPATH**/ ?>