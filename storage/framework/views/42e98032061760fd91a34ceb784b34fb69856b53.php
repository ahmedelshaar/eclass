          ...
          <table id="" class="displaytable table table-striped table-bordered w-100">
            ...
            <tbody>
              ...
              <tr>
                <?php $i++;?>
                <td>    
                    <input type="checkbox" form="bulk_delete_formrrepor" class="filled-in material-checkbox-input check" name="checked[]" value="<?php echo e($report->id); ?>" id="checkbox<?php echo e($report->id); ?>">
...
<?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/course/reviewreport/index.blade.php ENDPATH**/ ?>