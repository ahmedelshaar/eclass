            ...
            <div class="col-lg-8">
                <div class="about-home-block text-white">
                    ...
                    <ul>
                        ...
                        <ul>
                            <li><a href="#" title="about"><?php echo e(__('frontstaticword.Created')); ?>:
                                    <?php echo e($bundle->user['fname']); ?> </a></li>
                            <li><a href="#" title="about"><?php echo e(__('frontstaticword.LastUpdated')); ?>:
                                    ...
                                    <div class="about-home-rate">
                                        <ul>
                                            ...
                                            <?php if($bundle->discount_price == !null): ?>
                                                ...
                                                <li><?php echo e(currency($bundle->discount_price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = true)); ?>/<?php echo e($bundle->billing_interval); ?></li>

                                                <li><span><s><?php echo e(currency($bundle->price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = true)); ?>/<?php echo e($bundle->billing_interval); ?></s></span></li>
                                                
                                            <?php else: ?>
                                                
                                                <li><?php echo e(currency($bundle->price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = true)); ?>/<?php echo e($bundle->billing_interval); ?></li>
                                                    ...
                                                    <form id="demo-form2" method="post"
                                                        ...
                                                        <div class="box-footer">
                                                            <button type="submit" class="btn btn-primary"><i
                                                                    ...
                                                                    aria-hidden="true"></i>&nbsp;<?php echo e(__('frontstaticword.RemoveFromCart')); ?></button>
                                                        </div>
                                                    </form>
                                                </div>
                                            <?php else: ?>
                                                        ...
                                                        <div class="box-footer">
                                                            <?php if($bundle->is_subscription_enabled == 1): ?>
                                                                <button type="submit" class="btn btn-primary"><i
                                                                        ...
                                                                        aria-hidden="true"></i>&nbsp;<?php echo e(__('frontstaticword.SubscribeNow')); ?></button>
                                                            <?php else: ?>
                                                                <button type="submit" class="btn btn-primary"><i
                                                                        class="fa fa-cart-plus"
                                                                        aria-hidden="true"></i>&nbsp;<?php echo e(__('frontstaticword.AddToCart')); ?></button>
                                                            <?php endif; ?>
                                                        </div>
                                                    </form>
                                                </div>
                                ...
                                <?php else: ?>
                                    <div class="about-home-btn btm-20">
                                        ...
                                        <?php else: ?>
                                            ...
                                            <a href="<?php echo e(route('login')); ?>" class="btn btn-primary"><i
                                                    class="fa fa-cart-plus"
                                                    aria-hidden="true"></i>&nbsp;<?php echo e(__('frontstaticword.AddToCart')); ?></a>
                                        <?php endif; ?>
                                    </div>
                                <?php endif; ?>
                            <?php else: ?>
                                        ...
                                        <?php if($enroll == null): ?>
                                            <div class="about-home-btn btm-20">
                                                <a href="<?php echo e(url('bundle/enroll', $bundle->id)); ?>"
                                                    ...
                                                    title="Enroll Now"><?php echo e(__('frontstaticword.EnrollNow')); ?></a>
                                            </div>
                                        <?php else: ?>
                                            <div class="about-home-btn btm-20">
                                                <a href="" class="btn btn-secondary"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="about-home-share text-center">
                                        <a href="https://calendar.google.com/calendar/r/eventedit?text=<?php echo e($bundle['title']); ?>" target="__blank"><i class="fa fa-calendar"></i>&nbsp;<?php echo e(__('reminder')); ?></a>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="about-home-share text-center">
                                        <a href="#" data-toggle="modal" data-target="#myModalshare" title="share" data-dismiss="modal"><i class="fa fa-share rgt-10"></i><?php echo e(__('frontstaticword.share')); ?></a>
                                    </div>
                                </div>
                            </div>
                                      ...
                                      <div class="panel panel-sum">
                                        <div class="modal-body">
                                            ...
                                            <div class="nav-search">
                                                ...
                                                <button onclick="myFunction()" class="btn btn-primary"><?php echo e(__('frontstaticword.CopyText')); ?></button>
                                            </div>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="requirements">
                    <h3><?php echo e(__('frontstaticword.Detail')); ?></h3>
                    <ul>
                ...
                <div class="course-content-block btm-30">
                    <h3><?php echo e(__('frontstaticword.CoursesInBundle')); ?></h3>
                    <!-- FSMS -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('theme.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/front/bundle_detail.blade.php ENDPATH**/ ?>