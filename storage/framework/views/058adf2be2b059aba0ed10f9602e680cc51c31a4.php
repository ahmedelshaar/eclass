        ...
        <div class="col-md-12 align-self-center">
            <div class="togglebar">
                <ul class="list-inline mb-0">
                    ...
                    <li class="list-inline-item">
                        <div class="menubar">
                            <a class="menu-hamburger" href="javascript:void();">
                               <img src="<?php echo e(url('admin_assets/assets/images/svg-icon/menu.svg')); ?>" class="img-fluid menu-hamburger-collapse" alt="menu">
                               <img src="<?php echo e(url('admin_assets/assets/images/svg-icon/close.svg')); ?>" class="img-fluid menu-hamburger-close" alt="close">
                             </a>
                         </div>
                    </li>
            ...
            <div class="infobar">
                ...
                <li class="list-inline-item">
                    ...
                    <li class="list-inline-item">
                        <div class="languagebar">
                        <a href="<?php echo e(url('/')); ?>" target="_blank"><span class="live-icon"><?php echo e(__('Visit Site')); ?></span></a>   
                        </div>
                    </li>
                    <!-- = site visit end -->
...
<!-- End Breadcrumbbar -->
            <?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/layouts/topbar.blade.php ENDPATH**/ ?>