        ...
        <div class="panel panel-sum">
          <div class="modal-body">
            <form id="demo-form2" method="post" action="<?php echo e(route('previous-paper.store')); ?>" data-parsley-validate
              ...
              <div class="col-md-12">
                <label for=""><?php echo e(__('adminstaticword.Title')); ?>:<sup class="redstar">*</sup></label>
...
</script><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/course/previous_paper/index.blade.php ENDPATH**/ ?>