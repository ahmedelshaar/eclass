...
unset($__errorArgs, $__bag); ?>
                          src="<?php echo e(url('images/user_img/'.$cat->user->user_img)); ?>" alt="profilephoto"
                          class="img-fluid" data-toggle="modal"
                          data-target="#exampleStandardModal<?php echo e($cat->user->id); ?>">

              <?php else: ?>
              <button type="button" class="dropdown-item" data-toggle="modal"
                      data-target="#exampleStandardModal<?php echo e($cat->user->id); ?>"><img <?php $__errorArgs = ['photo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                          src="<?php echo e(Avatar::create($cat->user->fname)->toBase64()); ?>" alt="profilephoto"
                          class="img-fluid">
                  </button>
              <?php endif; ?>
            ...
            <div class="card-body">
              <div style="list-style-type: none;" class="mt-4"><a href="#" style="color:black"><?php echo e(__('Type')); ?> <span
                    class="button-align">
                    <?php if($cat->type == '1'): ?>
                    paid
                     <?php else: ?>
            ...
            <div class="card-footer">
              <div class="row mt-3 mb-3">
                <div class="col-1"></div>
                <div class="col-2">
                  <a href="<?php echo e(route('course.show',$cat->id)); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/course/partial/index.blade.php ENDPATH**/ ?>