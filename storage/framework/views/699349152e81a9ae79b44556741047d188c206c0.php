    ...
    <div class="card m-b-30">
      <div class="card-header">
        ...
        <a data-toggle="modal" data-target="#myModalabcde" href="#" class="btn btn-primary-rgba"><i
            class="feather icon-plus "></i><?php echo e(__('Add Question Answer')); ?></a></div>
      <div class="card-body">
            ...
            <div class="modal-body">
              <form id="demo-form2" method="post" action="<?php echo e(route('questionanswer.store')); ?>" data-parsley-validate
                ...
                <input type="hidden" name="instructor_id" class="form-control select2"
                  ...
                  <label class="d-none" for="exampleInputSlug"> <?php echo e(__('adminstaticword.Course')); ?><span class="redstar">*</span></label>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <label for="exampleInputDetails"><?php echo e(__('adminstaticword.Question')); ?> :<sup
...
</script><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/course/questionanswer/index.blade.php ENDPATH**/ ?>