                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          <label class="text-dark"><?php echo e(__('adminstaticword.AppName')); ?>: </label>
                                  ...
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          <label class="text-dark" ><?php echo e(__('adminstaticword.ThemeColorforheader')); ?> : </label>
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                    <label class="text-dark" for=""><?php echo e(__('adminstaticword.BackgroundColor')); ?> :</label>
...
<?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/pwasetting/manifest.blade.php ENDPATH**/ ?>