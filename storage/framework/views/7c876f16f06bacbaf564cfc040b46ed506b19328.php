          ...
          <table id="" class="displaytable table table-striped table-bordered w-100">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    <label class="switch">
                      <input class="slider" type="checkbox"  data-id="<?php echo e($an->id); ?>" name="status" <?php echo e(($an->status == 1 ) ? 'checked' : ''); ?> onchange="ancourse1234('<?php echo e($an->id); ?>')" />
...
<?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/course/announsment/index.blade.php ENDPATH**/ ?>