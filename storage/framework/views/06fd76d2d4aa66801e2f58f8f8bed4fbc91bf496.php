...
<body>
  ...
  <section id="wishlist-home" class="invoice-home-main-block">
    <div class="container-fluid">
      <div class="invoiceheading"><?php echo e(__('frontstaticword.Invoice')); ?></div>
    </div>
  </section>
  <!-- about-home end -->
        ...
        <div class="border-one">
          ...
          <div class="order-table table-responsive">
            <table class="table table-striped">
              <thead>
                <tr>
                  <th class="invoice-col"><?php echo e(__('frontstaticword.Courses')); ?></th>
                  <th class="invoice-col"><?php echo e(__('frontstaticword.Instructor')); ?></th>
                  <th class="invoice-col"><?php echo e(__('frontstaticword.Currency')); ?></th>
                  <?php if($orders->coupon_discount != 0): ?>
                  <th class="text-center invoice-col">Coupon Discount</th>
                  <?php endif; ?>
                  <th class="txt-rgt invoice-col"><?php echo e(__('frontstaticword.Total')); ?></th>
                </tr>
              </thead>
              <tbody>
                <tr class="view-order">
...
</html><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/front/purchase_history/download.blade.php ENDPATH**/ ?>