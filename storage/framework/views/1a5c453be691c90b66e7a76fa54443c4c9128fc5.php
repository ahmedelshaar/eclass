					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="form-group">
								<label class="text-dark"><?php echo e(__('adminstaticword.ClientID')); ?> :</label>
						...
						<div class="col-md-12">
							<div class="form-group">
								<label class="text-dark"><?php echo e(__('adminstaticword.ClientSecretKey')); ?>:</label>
						...
						<div class="col-md-12">
							<div class="form-group">
								<label class="text-dark"><?php echo e(__('adminstaticword.CallbackURL')); ?> :</label>
						...
						<div class="col-md-12">
							<div class="form-group">
								<label class="text-dark" for=""><i class="fa fa-facebook-square"></i> <?php echo e(__('adminstaticword.EnableFacebookLogin')); ?> :</label><br>
				...
				<div class="card-body">
					...
					<form class="form" action="<?php echo e(route('sl.gl')); ?>" method="POST" novalidate enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="text-dark" for=""><i class="fa fa-google"></i> <?php echo e(__('adminstaticword.EnableGoogleLogin')); ?> : </label><br>
				...
				<div class="card-body">
					...
					<form class="form" action="<?php echo e(route('sl.git')); ?>" method="POST" novalidate enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="text-dark" for=""><i class="fa fa-gitlab"></i> <?php echo e(__('adminstaticword.EnableGitLabLogin')); ?>: </label><br>
				...
				<div class="card-body">
					...
					<form class="form" action="<?php echo e(route('sl.amazon')); ?>" method="POST" novalidate enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="text-dark" for=""><i class="fa fa-amazon"></i> <?php echo e(__('adminstaticword.EnableAmazonLogin')); ?>: </label><br>
				...
				<div class="card-body">
					...
					<form class="form" action="<?php echo e(route('sl.linkedin')); ?>" method="POST" novalidate enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="text-dark" for=""><i class="fa fa-linkedin"></i> <?php echo e(__('adminstaticword.EnableLinkedLogin')); ?>: </label><br>
				...
				<div class="card-body">
					...
					<form class="form" action="<?php echo e(route('sl.twitter')); ?>" method="POST" novalidate enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="text-dark" for=""><i class="fa fa-twitter"></i> <?php echo e(__('adminstaticword.EnableTwitterLogin')); ?>: </label><br>
	...
	</div><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/setting/sociallogin.blade.php ENDPATH**/ ?>