<div class="form-group<?php echo e($errors->has('css') ? ' has-error' : ''); ?>">
    <form action="<?php echo e(route('css.store')); ?>" method="POST">
      <?php echo e(csrf_field()); ?>
        ...
        <label class="text-dark" for="css"><?php echo e(__('adminstaticword.CustomCSS')); ?> :</label>
...
<div class="form-group<?php echo e($errors->has('js') ? ' has-error' : ''); ?>">
    <form action="<?php echo e(route('js.store')); ?>" method="POST">
      <?php echo e(csrf_field()); ?>
        ...
        <label class="text-dark" for="js"><?php echo e(__('adminstaticword.CustomJS')); ?> :</label>
...
</div><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/setting/customstyle.blade.php ENDPATH**/ ?>