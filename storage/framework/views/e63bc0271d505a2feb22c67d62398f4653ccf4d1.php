<head>
<meta charset="utf-8" />
<title>Network Error | <?php echo e($gsetting->project_title); ?></title>
    ...
    <div class="container-fluid">
        <div class="error-block text-center"> 
            ...
            <div class="nav-bar-btn btm-20">
                <a href="<?php echo e(url('/')); ?>" class="btn btn-secondary" title="home"><i class="fa fa-chevron-left"></i>Back to Home</a>
            </div>
        </div>
    </div>
</section>
...
<script src="<?php echo e(url('js/colorbox.js')); ?>"></script>
...
<?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/offline.blade.php ENDPATH**/ ?>