                          ...
                          <tr>
                            ...
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                  <a class="dropdown-item" href="<?php echo e(url('refundorder/'.$refund->id.'/edit')); ?>"><i class="feather icon-eye mr-2"></i><?php echo e(__('View')); ?></a>
                                  <a class="dropdown-item btn btn-link" data-toggle="modal" data-target="#delete<?php echo e($refund->id); ?>" >
...
<!-- End row -->
</div><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/refund_order/index.blade.php ENDPATH**/ ?>