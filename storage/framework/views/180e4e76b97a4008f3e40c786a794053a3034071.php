        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-4">
                <div class="Login-btn txt-rgt">
                    <a href="<?php echo e(route('register')); ?>" class="btn btn-primary" title="signup"><?php echo e(__('frontstaticword.Signup')); ?></a>
                </div> 
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="col-md-6 offset-md-3">
            <div class="signup-heading">
                <?php echo e(__('frontstaticword.LogIntoYour')); ?> <?php echo e($gsetting->project_title); ?> <?php echo e(__('frontstaticword.Account')); ?>!
            </div>
...
<?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/auth/login.blade.php ENDPATH**/ ?>