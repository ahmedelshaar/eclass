        ...
        <div class="panel panel-sum">
          <div class="modal-body">
            ...
            <select class="d-none" name="user_id" class="form-control select2">
              ...
              <div class="row">
                <div class="col-md-12">
                  <label for="exampleInputDetails"><?php echo e(__('adminstaticword.RelatedCourse')); ?>:<sup
                  ...
                  <small> <?php echo e(__('adminstaticword.Select')); ?> <?php echo e(__('adminstaticword.RelatedCourse')); ?></small>
                </div>
              </div>
              <br>
              <div class="row">
...
<?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/course/relatedcourse/index.blade.php ENDPATH**/ ?>