...
<?php $__env->startSection('title','Edit Courseclass'); ?>
...
<?php echo e(__('Edit Course Class')); ?>
...
<div class="contentbar">
  ...
  <?php endif; ?>
    <div class="col-lg-7">
      <div class="card m-b-30">
        <div class="card-header">
          <h5 class="box-title"><?php echo e(__('adminstaticword.Edit')); ?> <?php echo e(__('Course Class')); ?></h5>
        </div>
          ...
          <form enctype="multipart/form-data" id="demo-form" method="post" action="<?php echo e(url('courseclass/'.$cate->id)); ?>"data-parsley-validate class="form-horizontal form-label-left">
            ...
            <?php if($cate->type =="video"): ?>
              <div class="row">
                <div class="col-md-12" id="videotype">
                  <input type="radio" name="checkVideo" id="ch1" value="url" <?php echo e($cate->url !="" ? 'checked' : ""); ?>>&nbsp;<?php echo e(__('adminstaticword.URL')); ?>&emsp;
                  <input type="radio" name="checkVideo" id="ch2" value="uploadvideo" <?php echo e($cate->video !="" ? 'checked' : ""); ?>>&nbsp;<?php echo e(__('adminstaticword.UploadVideo')); ?>&emsp;
                  <input type="radio" name="checkVideo" id="ch9" value="iframeurl" <?php echo e($cate->iframe_url !="" ? 'checked' : ""); ?>>&nbsp;<?php echo e(__('adminstaticword.IframeURL')); ?>&emsp;
                  <input type="radio" name="checkVideo" id="ch10" value="liveurl" <?php echo e($cate->date_time !="" ? 'checked' : ""); ?>>&nbsp;<?php echo e(__('adminstaticword.LiveClass')); ?>&emsp;
                  

                  <?php if($gsetting->aws_enable == 1): ?>
                  <input type="radio" name="checkVideo" id="ch13" value="aws_upload" <?php echo e($cate->aws_upload !="" ? 'checked' : ""); ?>>&nbsp;<?php echo e(__('adminstaticword.AWSUpload')); ?>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div id="awsUpload" <?php if($cate->video !=NULL || $cate->iframe_url !=NULL || $cate->url): ?> class="display-none" <?php endif; ?> >
                    <label for=""><?php echo e(__('adminstaticword.AWSUpload')); ?>: </label>
                    <!-- =========== -->
                  <div class="input-group mb-3">
                    ...
                    <?php if($cate->aws_upload !=""): ?>
                      <label for=""><?php echo e(__('adminstaticword.AWSFileName')); ?>:</label>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div id="videoURL" <?php if($cate->video !=NULL || $cate->iframe_url !=NULL || $cate->aws_upload !=NULL): ?> class="display-none" <?php endif; ?> >
              ...
              <div class="row">
                <div class="col-md-12">
                  <div id="iframeURLBox" <?php if($cate->url !=NULL || $cate->video !=NULL || $cate->aws_upload !=NULL): ?> class="display-none" <?php endif; ?> >
              ...
              <div class="row">
                <div class="col-md-12">
                  <div id="liveURLBox" <?php if($cate->iframe_url !=NULL || $cate->video !=NULL || $cate->aws_upload !=NULL || $cate->url !=NULL): ?> class="display-none" <?php endif; ?> >
            ...
            <?php if($cate->type =="audio"): ?>
                ...
                <div class="form-group">
                  <div class="col-md-12">
                    <input type="radio" name="checkAudio" id="ch11" value="audiourl" <?php echo e($cate->url !="" ? 'checked' : ""); ?>> <?php echo e(__('adminstaticword.URL')); ?>

                    <input type="radio" name="checkAudio" id="ch12"  <?php echo e($cate->audio !="" ? 'checked' : ""); ?> value="uploadaudio"> <?php echo e(__('adminstaticword.UploadAudio')); ?>
                ...
                <div class="form-group">
                  <div class="col-md-12">
                    <div id="audioURL" <?php if($cate->audio != ""): ?> class="display-none" <?php endif; ?> >
                      <label for=""><?php echo e(__('adminstaticword.URL')); ?>: </label>
                ...
                <div class="form-group">
                  <div class="col-md-12">
                    <div id="audioUpload" <?php if($cate->url !=""): ?> class="display-none" <?php endif; ?> >
                    ...
                    <br>
                    <?php if($cate->audio !=""): ?>
                    <label for=""><?php echo e(__('adminstaticword.AudioFileName')); ?>:</label>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div <?php if($cate->preview_type =="url" ): ?> class="display-none" <?php endif; ?> id="document11">
                  <label for="exampleInputSlug"><?php echo e(__('Preview')); ?> <?php echo e(__('adminstaticword.UploadVideo')); ?>: <sup class="redstar">*</sup></label>
                   <!-- =========== -->
                   <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroupFileAddon01"><?php echo e(__('Upload')); ?></span>
                ...
                <div <?php if($cate->preview_type =="video"): ?> class="display-none" <?php endif; ?> id="document22">
                  ...
                  <label for="exampleInputSlug"><?php echo e(__('Preview')); ?> <?php echo e(__('adminstaticword.URL')); ?>: <sup class="redstar">*</sup></label>
            ...
            <div class="row">
              <div class="col-md-12">
                <label for="exampleInputDetails"><?php echo e(__('adminstaticword.LearningMaterial')); ?></label> - <p class="inline info">eg: zip or pdf files</p>
                  <!-- =========== -->
                  <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroupFileAddon01"><?php echo e(__('Upload')); ?></span>
    ...
    <div class="col-lg-5">
      <div class="card m-b-30">
        <div class="card-header">
          <h5 class="box-title"><?php echo e(__('adminstaticword.Subtitle')); ?></h5>
        </div>
        <div class="card-body ml-2">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/course/courseclass/edit.blade.php ENDPATH**/ ?>