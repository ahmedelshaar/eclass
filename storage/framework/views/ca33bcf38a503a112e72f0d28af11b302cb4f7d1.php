		...
		<div class="row">
			...
			<div class="col-lg-3">
				<div class="class-button">
					<ul>
						<li>
							<a href="<?php echo e(route('mycourse.show')); ?>" class="course_btn"> <i class="fa fa-chevron-left"></i><?php echo e(__('frontstaticword.MyCourses')); ?></a>
						</li>
						<li>
							<a href="<?php echo e(route('course.content',['id' => $courses->id, 'slug' => $courses->slug ])); ?>" class="course_btn"> <?php echo e(__('frontstaticword.CourseContent')); ?> <i class="fa fa-chevron-right"></i></a>
						</li>
					</ul>
				</div>
			</div>
...
<?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/iframe.blade.php ENDPATH**/ ?>