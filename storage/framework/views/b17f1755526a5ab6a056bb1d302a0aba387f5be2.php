<form action="<?php echo e(route('update.mail.set')); ?>" method="POST">
	...
	<div class="row">
		<div class="col-md-6">
			<label class="text-dark" for=""><?php echo e(__('adminstaticword.SenderName')); ?> :</label>
            ...
            <?php endif; ?>
            <br>
            <label class="text-dark" for=""><?php echo e(__('adminstaticword.MAILDRIVER')); ?> : <?php echo e(__('(ex. SMTP, MAIL, SENDMAIL)')); ?></label>
            ...
            <?php endif; ?>
            <br>
            <label class="text-dark" for=""><?php echo e(__('adminstaticword.MAILHOST')); ?> : <span class="text-danger">*</span> <?php echo e(__('(ex. smtp.mailtrap.io)')); ?></label> 
            ...
            <?php endif; ?>
            <br>
            <label class="text-dark" for=""><?php echo e(__('adminstaticword.MAILPORT')); ?> : <span class="text-danger">*</span> <?php echo e(__('(ex. 2525,467)')); ?></label>
        ...
        <div class="col-md-6">
            <label class="text-dark" for=""><?php echo e(__('adminstaticword.MAILADDRESS')); ?> : <span class="text-danger">*</span></label>
            ...
            <?php endif; ?>
            <br>
            <label class="text-dark" for=""><?php echo e(__('adminstaticword.MAILUSERNAME')); ?> : <span class="text-danger">*</span> <?php echo e(__('(ex. info@test.com)')); ?></label>
            ...
            <div class="row">
                <div class="col-md-11">
                    <label class="text-dark" for=""><?php echo e(__('adminstaticword.MAILPASSWORD')); ?> : <span class="text-danger">*</span> </label>
                ...
                <?php endif; ?>
            <br>
            <label class="text-dark" for=""><?php echo e(__('adminstaticword.MAILENCRYPTION')); ?> : <?php echo e(__('(ex. TLS/SSL)')); ?></label>
...
<?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/setting/mailsetting.blade.php ENDPATH**/ ?>