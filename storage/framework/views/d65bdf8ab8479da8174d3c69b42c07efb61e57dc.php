...
<div class="dropdown">
    <button type="button" class="btn btn-rounded btn-danger-rgba btn-sm" data-toggle="modal" data-target="#deleteModal<?php echo e($id); ?>"><?php echo e(__('Delete')); ?> </button>
    ...
    <!-- Model ended -->
</div><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/currency/manage/action.blade.php ENDPATH**/ ?>