                        ...
                        <li>
                            <div class="dropdown">
                              ...
                              <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="fas fa-trophy"></i>&nbsp; <?php echo e(__('frontstaticword.GetCertificate')); ?>

                              </button>
                              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <?php if(!empty($progress)): ?>
                                <a class="dropdown-item"> 
                                    <?php echo e($read_count); ?> <?php echo e(__('frontstaticword.of')); ?> <?php echo e($total_count); ?>  <?php echo e(__('frontstaticword.complete')); ?>
                                ...
                                <?php if(!empty($progress)): ?>
                                    ...
                                    <div class="about-home-btn">
                                        ...
                                        <a href="<?php echo e(route('certificate.show',['slug' => $random ])); ?>" class="btn btn-secondary" href="#">Get Certificate</a>
                                    </div>
                                    <?php endif; ?>
                                <?php endif; ?>
                              </div>
                    ...
                    <?php if(isset($items)): ?>
                        ...
                        <?php if(isset($course->chapter[0]->courseclass[0])): ?>
                            ...
                            <div class="learning-courses-home-btn">
                                <a href="<?php echo e(route('watchcourse',$course->id)); ?>" class="<?php if($z == 0): ?>iframe <?php endif; ?> btn btn-primary" title="Continue"><?php echo e(__('frontstaticword.ContinuetoLecture')); ?></a>
                            </div>
                            <?php else: ?>
                            <div class="learning-courses-home-btn">
                                <?php
        ...
        <div class="about-block">
            ...
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <a class="nav-item nav-link text-center" id="nav-assign-tab" data-toggle="tab" href="#nav-assign" role="tab" aria-controls="nav-assign" aria-selected="false"><?php echo e(__('frontstaticword.Assignment')); ?></a>
                    <?php endif; ?>
                    <?php endif; ?>
                    
                    <?php if($gsetting->appointment_enable == 1): ?>
                    <?php if($course->appointment_enable == 1): ?>
                    <a class="nav-item nav-link text-center" id="nav-appoint-tab" data-toggle="tab" href="#nav-appoint" role="tab" aria-controls="nav-appoint" aria-selected="false"><?php echo e(__('frontstaticword.Appointment')); ?></a>
                    <?php endif; ?>
                    <?php endif; ?>
                    

                    <?php if(count($papers) > 0): ?>
                    <a class="nav-item nav-link text-center" id="nav-paper-tab" data-toggle="tab" href="#nav-paper" role="tab" aria-controls="nav-paper" aria-selected="false"><?php echo e(__('frontstaticword.PreviousPapers')); ?></a>
                    <?php endif; ?>
            ...
            <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="learning-questions-block btm-40">
                                    ...
                                    <?php endif; ?>
                                    <div class="learning-questions-heading"><a href="#" id="goTab4" title="browse"><?php echo e(__('frontstaticword.Browsequestions')); ?></a>
                                    </div>
                                </div>
                            </div>
                            <?php if(count($announsments) > 0): ?>
                            <div class="col-lg-6">
                                <div class="learning-questions-block btm-40">
                                    ...
                                    <?php endif; ?>
                                    <div class="learning-questions-heading"><a id="goTab5" href="" title="browse"><?php echo e(__('frontstaticword.Browseannouncements')); ?></a>
                                    </div>
                                </div>
                            </div>
                            <?php endif; ?>
                                        ...
                                        <div class="content-img-block btm-20">
                                            ...
                                            <div class="content-img-dtl">
                                                <div class="profile">
                                                        ...
                                                        <?php echo e($course->user->fname); ?> <?php echo e($course->user->lname); ?>
                    ...
                    <div class="profile-block">
                        ...
                        <div class="mark-read-button">
                            <button type="submit" class="btn btn-md btn-primary">
                                <?php echo e(__('frontstaticword.MarkasComplete')); ?>
                ...
                <div class="tab-pane fade" id="nav-quiz" role="tabpanel" aria-labelledby="nav-quiz-tab">
                    <div class="container">
                        <div class="quiz-main-block">
                          ...
                          <h5><?php echo e(__('frontstaticword.Objective')); ?></h5>
                          <div class="row">
                            <?php 
                          ...
                          <h5><?php echo e(__('frontstaticword.Subjective')); ?></h5>
                          <div class="row">
                            <?php 
                                   ...
                                   <div class="card-action text-center">
                                      ...
                                      <?php if(empty($users)): ?>
                                        <?php if($quiz_question != null || $quiz_question!= ''): ?>
                                            ...
                                            <a href="<?php echo e(route('sub_start_quiz', ['id' => $topic->id])); ?>" class="btn btn-block" title="Start Quiz"> <?php echo e(__('frontstaticword.StartQuiz')); ?></a>
                                        
                                        <?php endif; ?>
                                      <?php else: ?>
                                         <a href="<?php echo e(route('sub.start.quiz.show',$topic->id)); ?>" class="btn btn-block"><?php echo e(__('frontstaticword.ShowQuizReport')); ?> </a>
                                       
                                        <?php if($topic->quiz_again == '1'): ?>
                                         <a href="<?php echo e(route('sub.tryagain',$topic->id)); ?>" class="btn btn-block"><?php echo e(__('frontstaticword.TryAgain')); ?> </a>
                                        <?php endif; ?>
                                      <?php endif; ?>
                ...
                <div class="tab-pane fade" id="nav-assign" role="tabpanel" aria-labelledby="nav-assign-tab">
                    <div class="container">
                        <div class="assignment-main-block">
                            <h3><?php echo e(__('frontstaticword.YourAssignments')); ?></h3>
                          <div class="row">
                                                ...
                                                <table>
                                                    <td>
                                                        ...
                                                        <?php if($assign->type == 1): ?>
                                                         <a href="" data-toggle="tooltip" data-placement="top" title="<?php echo e($assign->rating); ?>/10 scores"><i class="far fa-check-circle" title="approved"></i></a>
                                                        <?php else: ?>
                                                        <i class="far fa-times-circle" title="pending"></i>
                                                        <?php endif; ?>
                                                        <span><?php echo e(__('frontstaticword.Title')); ?>:<?php echo e($assign->title); ?></span>
                                                        </div>
                                                         <div class="col-md-6">
                                                            <div class="assignment-delete-block text-right">

                                                            <a href="<?php echo e(asset('files/assignment/'.$assign->assignment)); ?>" download="<?php echo e($assign->assignment); ?>" title="Download"> <i class="fa fa-download"></i></a>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="contact-search-block btm-40">
                                    ...
                                    <div class="udemy-contact-btn text-center">
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#assignmodel"><?php echo e(__('frontstaticword.SubmitAssignment')); ?>
                                    ...
                                    <div class="modal fade" id="assignmodel" role="dialog" aria-labelledby="myModalLabel">
                                        <div class="modal-dialog modal-lg" role="document">
                                          <div class="modal-content">
                                            <div class="modal-header">
                                              <h4 class="modal-title" id="myModalLabel"><?php echo e(__('frontstaticword.SubmitAssignment')); ?></h4>
                                              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                            </div>
                                            <div class="box box-primary">
                                              <div class="panel panel-sum">
                                                    ...
                                                    <form id="demo-form2" method="post" action="<?php echo e(route('assignment.submit', $course->id)); ?>" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                                                        ...
                                                        <div class="row">
                                                          <div class="col-md-12">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="exampleInputDetails"><?php echo e(__('adminstaticword.ChapterName')); ?>:<sup class="redstar">*</sup></label>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="wrapper">
                                                                   <label for="detail"><?php echo e(__('frontstaticword.AssignmentUpload')); ?>:<sup class="redstar">*</sup></label> 
                ...
                <div class="tab-pane fade" id="nav-appoint" role="tabpanel" aria-labelledby="nav-appoint-tab">
                    <div class="container">
                        <div class="appointment-main-block">
                            <h3><?php echo e(__('frontstaticword.YourAppointment')); ?></h3>
                          <div class="row">
                                            ...
                                            <div class="categories-block assign-tab-one text-center">
                                                <ul>
                                                    ...
                                                    <li>
                                                        ...
                                                        <button  type="submit" class="cart-remove-btn display-inline" title="Remove From cart"> <?php echo e(__('frontstaticword.Delete')); ?></button>
                                                      </form>
                                                        ...
                                                        <div class="modal-dialog modal-lg" role="document">
                                                          <div class="modal-content">
                                                            <div class="modal-header">
                                                              ...
                                                              <h4 class="modal-title" id="myModalLabel"><?php echo e(__('frontstaticword.Response')); ?></h4>
                                                              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                            </div>
                                                            <div class="box box-primary">
                                                              <div class="panel panel-sum">
                                                                <div class="modal-body">
                                                                  <div class="instructor-detail">
                                                                    <ul>
                                                                        ...
                                                                        <li>
                                                                            <?php echo e(__('frontstaticword.Instructor')); ?>: <?php echo e($appoint->instructor->fname); ?> <?php echo e($appoint->instructor->lname); ?>

                                                                        </li>
                                                                        <li>
                                                                            <?php echo e(__('frontstaticword.Email')); ?>: <?php echo e($appoint->instructor->email); ?>

                                                                        </li>
                                                                        <li>
                                                                            <?php echo e(__('frontstaticword.Response')); ?>: <?php echo $appoint->reply; ?>
                            ...
                            <div class="col-md-4">
                                <div class="contact-search-block btm-40">
                                    <div class="udemy-contact-btn text-center">
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#appointmodel"><?php echo e(__('frontstaticword.RequestAppointment')); ?>
                                    ...
                                    <div class="modal fade" id="appointmodel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                        <div class="modal-dialog modal-lg" role="document">
                                          <div class="modal-content">
                                            <div class="modal-header">
                                              <h4 class="modal-title" id="myModalLabel"><?php echo e(__('frontstaticword.RequestAppointment')); ?></h4>
                                              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                            </div>
                                            <div class="box box-primary">
                                              <div class="panel panel-sum">
                                                <div class="modal-body">
                                                    <form id="demo-form2" method="post" action="<?php echo e(route('appointment.request', $course->id)); ?>" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                                                        ...
                                                        <div class="row">
                                                          <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="title"><?php echo e(__('frontstaticword.User')); ?>:<sup class="redstar">*</sup></label>
                                                                <input type="text" name="fname" value="<?php echo e(Auth::user()->email); ?>" class="form-control" disabled />
                                                            </div>
                                                          </div>
                                                          <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="title"><?php echo e(__('frontstaticword.Instructor')); ?>:<sup class="redstar">*</sup></label>
                                                        ...
                                                        <div class="row">
                                                          ...
                                                          <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="title"><?php echo e(__('frontstaticword.Date')); ?>:<sup class="redstar">*</sup></label>
                ...
                <div class="tab-pane fade" id="nav-paper" role="tabpanel" aria-labelledby="nav-paper-tab">
                    ...
                    <div class="assignment-main-block">
                        <h3><?php echo e(__('frontstaticword.AllPapers')); ?></h3>
                      <div class="row">
                                                ...
                                                <td>
                                                    ...
                                                    <div class="col-md-6">
                                                          ...
                                                          <div class="koh-tab-content-body">
                                                            <div class="koh-faq">
                                                              <div class="koh-faq-question">
                                                                ...
                                                                <span class="koh-faq-question-span"><?php echo e(__('frontstaticword.Title')); ?>:<?php echo e($paper->title); ?></span>
                                                     ...
                                                     <div class="col-md-6">
                                                        ...
                                                        <a href="<?php echo e(asset('files/papers/'.$paper->file)); ?>" download="<?php echo e($paper->file); ?>" title="Download"> <i class="fa fa-download"></i></a>
...
<?php echo $__env->make('theme.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/front/course_content.blade.php ENDPATH**/ ?>