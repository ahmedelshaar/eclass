        ...
        <form action="<?php echo e(route('cat.store')); ?>" method="POST">
          ...
          <div class="row">
            <div class="col-md-6">
             ...
             <div class="col-md-6">
              <label for="category"><?php echo e(__('adminstaticword.Slug')); ?>:<sup class="redstar">*</sup></label>
...
</div><?php /**PATH C:\xampp7\htdocs\eclass42n\eclass\resources\views/admin/category/subcategory/cat.blade.php ENDPATH**/ ?>